...
function AuthButton() {
  ...
  return (
    <button
      ...
      className="flex bg-transparent relative border-0 cursor-pointer hover:ring-2 rounded-md p-3 ring-orange-400 active:ring-4 items-center justify-center gap-x-3"
    >
      ...
      {dropDown && (
        <ul
          role="button"
          onClick={() => signOut()}
          className="list-none bg-white rounded-md text-center drop-shadow-md p-2 absolute 
          -right-24  
          md:-bottom-[65%] md:left-auto md:right-auto"
        >
          <div className="arrow-left absolute -left-3 top-auto bottom-auto"></div>
