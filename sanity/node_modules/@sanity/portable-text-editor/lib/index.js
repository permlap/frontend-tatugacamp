...
const _excluded = ["_type", "_key"],
  ...
  _excluded7 = ["hotkeys", "onBeforeInput", "onPaste", "onCopy", "renderAnnotation", "renderBlock", "renderChild", "renderDecorator", "renderListItem", "renderPlaceholder", "renderStyle", "selection", "scrollSelectionIntoView", "spellCheck"];
...
function validateValue(value, types, keyGenerator) {
  ...
  if (value.some((blk, index) => {
    ...
    if (blk._type === types.block.name) {
      ...
      if (!blk.markDefs) {
        resolution = {
          patches: [set(_objectSpread(_objectSpread({}, textBlock), {}, {
            markDefs: []
          }), [{
            _key: textBlock._key
          }])],
...
function createOperationToPatches(types) {
  ...
  function setNodePatch(editor, operation) {
    if (operation.path.length === 1) {
      ...
      const setNode = omitBy__default["default"](_objectSpread(_objectSpread({}, editor.children[operation.path[0]]), operation.newProperties), isUndefined__default["default"]);
...
function createWithEditableAPI(portableTextEditor, types, keyGenerator) {
  return function withEditableAPI(editor) {
    portableTextEditor.setEditable({
      ...
      marks: () => {
        return _objectSpread({}, slate.Editor.marks(editor) || {}).marks || [];
      },
      undo: () => editor.undo(),
      redo: () => editor.redo(),
      select: selection => {
...
function createPatchToOperations(schemaTypes, keyGenerator) {
  ...
  function setPatch(editor, patch) {
    ...
    if (isTextBlock) {
      ...
      slate.Transforms.setNodes(editor, _objectSpread(_objectSpread({}, block), {}, {
        value: newVal
      }), {
        at: [blockIndex]
      });
...
function createWithPatches(_ref6) {
  ...
  return [function withPatches(editor) {
    ...
    const syncValueAfterIncomingPatches = debounce__default["default"](() => syncValue(), 100, {
      trailing: true,
      leading: false
    });
    if (incomingPatches$) {
    ...
    editor.pteToggleBlockStyle = blockStyle => {
      ...
      selectedBlocks.forEach(_ref9 => {
        ...
        if (editor.isTextBlock(node) && node.style === blockStyle) {
          ...
          slate.Transforms.setNodes(editor, _objectSpread(_objectSpread({}, node), {}, {
            style: defaultStyle
          }), {
            at: path
          });
...
function createWithPortableTextMarkModel(types) {
  return function withPortableTextMarkModel(editor) {
      ...
      if (op.type === "insert_text") {
        ...
        if (selection && slate.Range.isCollapsed(selection) && ((_b = (_a = slate.Editor.marks(editor)) == null ? void 0 : _a.marks) == null ? void 0 : _b.some(mark => !decorators.includes(mark)))) {
          ...
          if (slate.Text.isText(node) && node.text.length === selection.focus.offset && Array.isArray(node.marks) && node.marks.length > 0) {
            ...
            const marksWithoutAnnotationMarks = (_objectSpread({}, slate.Editor.marks(editor) || {}).marks || []).filter(mark => decorators.includes(mark));
            slate.Transforms.setNodes(editor, {
    ...
    editor.addMark = mark => {
      if (editor.selection) {
        if (slate.Range.isExpanded(editor.selection)) {
          ...
          const existingMarks = _objectSpread({}, slate.Editor.marks(editor) || {}).marks || [];
          const marks = _objectSpread(_objectSpread({}, slate.Editor.marks(editor) || {}), {}, {
    ...
    editor.pteIsMarkActive = mark => {
      ...
      let existingMarks = _objectSpread({}, slate.Editor.marks(editor) || {}).marks || [];
      if (slate.Range.isExpanded(editor.selection)) {
  ...
  return fragment.map(node => {
    ...
    if (editor.isTextBlock(newNode)) {
      newNode.markDefs = (newNode.markDefs || []).map(def => {
        ...
        if (editor.isTextBlock(newNode)) {
          newNode.children = newNode.children.map(child => child._type === spanTypeName && editor.isTextSpan(child) ? _objectSpread(_objectSpread({}, child), {}, {
...
class PortableTextEditor extends React__default["default"].Component {
  constructor(props) {
    ...
    if (props.incomingPatches$) {
      this.incomingPatches$ = props.incomingPatches$.pipe(operators.tap(_ref17 => {
        let {
          patches
        } = _ref17;
...
function bufferUntil(emitWhen) {
  return source => rxjs.defer(() => {
    let buffer = [];
    return source.pipe(operators.tap(v => buffer.push(v)), operators.switchMap(() => emitWhen(buffer) ? rxjs.of(buffer) : rxjs.EMPTY), operators.tap(() => buffer = []));
  });
}
const NOOP$1 = () => void 0;
...
const Leaf = props => {
  ...
  return /* @__PURE__ */jsxRuntime.jsx("span", _objectSpread(_objectSpread({}, attributes), {}, {
    ref: spanRef,
...
const Element = _ref20 => {
  ...
  if (editor.isInline(element)) {
    ...
    if (slate.Element.isElement(block2)) {
      ...
      return /* @__PURE__ */jsxRuntime.jsxs("span", _objectSpread(_objectSpread({}, attributes), {}, {
  ...
  if (element._type === schemaTypes.block.name) {
    ...
    return /* @__PURE__ */jsxRuntime.jsx("div", _objectSpread(_objectSpread({}, attributes), {}, {
      className,
      spellCheck,
  ...
  return /* @__PURE__ */jsxRuntime.jsxs("div", _objectSpread(_objectSpread({}, attributes), {}, {
    className,
...
const PortableTextEditable = React.forwardRef(function PortableTextEditable2(props, forwardedRef) {
  ...
  const renderElement = React.useCallback(eProps => /* @__PURE__ */jsxRuntime.jsx(Element, _objectSpread(_objectSpread({}, eProps), {}, {
    schemaTypes,
    readOnly,
    renderBlock,
    renderChild,
  ...
  const renderLeaf = React.useCallback(lProps => {
    if (renderPlaceholder && lProps.leaf.placeholder && lProps.text.text === "") {
      return /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
        ...
        }), /* @__PURE__ */jsxRuntime.jsx(Leaf, _objectSpread(_objectSpread({}, lProps), {}, {
          keyGenerator,
          schemaTypes,
          renderAnnotation,
          renderChild,
    ...
    return /* @__PURE__ */jsxRuntime.jsx(Leaf, _objectSpread(_objectSpread({}, lProps), {}, {
      keyGenerator,
      schemaTypes,
      renderAnnotation,
      renderChild,
