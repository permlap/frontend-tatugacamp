...
const GroqLogo = forwardRef(function GroqLogo2(props, ref) {
...
const GroqMonogram = forwardRef(function GroqMonogram2(props, ref) {
  return /* @__PURE__ */jsxs("svg", _objectSpread(_objectSpread({
...
const SanityLogo = forwardRef(function SanityLogo2(props, ref) {
  const {
      dark
    } = props,
...
const SanityMonogram = forwardRef(function SanityMonogram2(props, ref) {
  const {
