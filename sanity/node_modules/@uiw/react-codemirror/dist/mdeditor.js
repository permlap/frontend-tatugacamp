    ...
    */
    name = "") {
        ...
        if (!state_.EditorState.prototype.hasOwnProperty("tree"))
            Object.defineProperty(state_.EditorState.prototype, "tree", { get() { return dist_syntaxTree(this); } });
        this.parser = parser;
        this.extension = [
            language.of(this),
            state_.EditorState.languageData.of((state, pos, side) => state.facet(languageDataFacetAt(state, pos, side)))
...
*/
const cursorLineEnd = view => moveSel(view, range => state_.EditorSelection.cursor(view.lineBlockAt(range.head).to, -1));
...
*/
const selectLineEnd = view => extendSel(view, range => state_.EditorSelection.cursor(view.lineBlockAt(range.head).to));
/**
...
function changeBySelectedLine(state, f) {
    ...
    return state.changeByRange(range => {
        ...
        let changeSet = state.changes(changes);
        return { changes,
            range: state_.EditorSelection.range(changeSet.mapPos(range.anchor, 1), changeSet.mapPos(range.head, 1)) };
    });
}
/**
