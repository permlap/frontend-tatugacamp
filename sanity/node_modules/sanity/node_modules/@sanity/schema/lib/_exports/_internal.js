...
const _excluded = ["name"],
  ...
  _excluded3 = ["name"],
  _excluded4 = ["_problems"],
  _excluded5 = ["name"],
  _excluded6 = ["_problems"];
...
var object = (typeDef, visitorContext) => {
  ...
  return _objectSpread(_objectSpread({}, typeDef), {}, {
    ...
    fields: (Array.isArray(typeDef.fields) ? typeDef.fields : []).map((field, index) => {
      ...
      const _visitorContext$visit = visitorContext.visit(fieldTypeDef, index),
        {
          _problems
        } = _visitorContext$visit,
  ...
  if (ofIsArray) {
    const invalid = typeDef.of.reduce((errs, def, idx) => {
      if (typeof def.name === "string") {
        if (def.name !== def.type && coreTypeNames.includes(def.name)) {
  ...
  return _objectSpread(_objectSpread({}, typeDef), {}, {
    fields: (Array.isArray(fields) ? fields : []).map((field, index) => {
      const {
        ...
        fieldTypeDef = _objectWithoutProperties(field, _excluded3);
      const _visitorContext$visit2 = visitorContext.visit(fieldTypeDef, index),
        {
          _problems
        } = _visitorContext$visit2,
        fieldType = _objectWithoutProperties(_visitorContext$visit2, _excluded4);
      return _objectSpread(_objectSpread({
        name
      }, fieldType), {}, {
        _problems: validateField(field).concat(_problems || [])
  ...
  return _objectSpread(_objectSpread({}, typeDef), {}, {
    ...
    fields: (Array.isArray(fields) ? fields : []).map((field, index) => {
      const {
        ...
        fieldTypeDef = _objectWithoutProperties(field, _excluded5);
      const _visitorContext$visit3 = visitorContext.visit(fieldTypeDef, index),
        {
          _problems
        } = _visitorContext$visit3,
        fieldType = _objectWithoutProperties(_visitorContext$visit3, _excluded6);
      return _objectSpread(_objectSpread({
        name
      }, fieldType), {}, {
        _problems: validateField(field).concat(_problems || [])
...
function validateBlockType(typeDef, visitorContext) {
  ...
  return _objectSpread(_objectSpread({}, omit__default["default"](typeDef, disallowedKeys)), {}, {
    marks,
    styles,
...
const getNoopVisitor = visitorContext => schemaDef => _objectSpread(_objectSpread({
