...
var mockBrowserEnvironment = require('../../../_chunks/mockBrowserEnvironment-fe928d66.js');
...
async function getStudioConfig(options) {
  ...
  try {
    ...
    workspaces = await sanity.resolveConfig(config).pipe(operators.first()).toPromise();
  } catch (error) {
    if (cleanup) {
      cleanup();
    }
...
function resolveGraphQLAPIsFromConfig(apiDefs, workspaces) {
  ...
  for (const apiDef of apiDefs) {
    ...
    resolvedApis.push(_objectSpread(_objectSpread({}, apiDef), {}, {
