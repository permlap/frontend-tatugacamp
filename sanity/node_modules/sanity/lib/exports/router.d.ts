...
export declare const IntentLink: React_2.ForwardRefExoticComponent<
  Pick<
    IntentLinkProps & React_2.HTMLProps<HTMLAnchorElement>,
    | 'name'
    | 'content'
    | 'src'
    | 'default'
...
export declare const Link: React_2.ForwardRefExoticComponent<
  Pick<
    LinkProps & React_2.HTMLProps<HTMLAnchorElement>,
    | 'replace'
    | 'name'
    | 'content'
    | 'src'
...
export declare const StateLink: React_2.ForwardRefExoticComponent<
  Pick<
    StateLinkProps & Omit<React_2.HTMLProps<HTMLAnchorElement>, 'href'>,
    | 'name'
    | 'content'
    | 'src'
    | 'default'
