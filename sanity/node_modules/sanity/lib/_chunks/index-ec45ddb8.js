...
var index = require('./index-4edba1d4.js');
var PathUtils = require('@sanity/util/paths');
var types = require('@sanity/types');
var sanity = require('sanity');
var PaneItem = require('./PaneItem-8061a627.js');
...
var shallowEquals__default = /*#__PURE__*/_interopDefaultLegacy(shallowEquals);
var PathUtils__namespace = /*#__PURE__*/_interopNamespace(PathUtils);
var deepCompare__default = /*#__PURE__*/_interopDefaultLegacy(deepCompare);
...
const getQueryResults = function (receivedProps$) {
  ...
  return queryResults$.pipe(operators.startWith(INITIAL_CHILD_PROPS), operators.catchError((err, caught$) => rxjs.concat(rxjs.of(createErrorChildProps(err)), rxjs.merge(rxjs.fromEvent(window, "online"), onRetry$).pipe(operators.take(1), operators.mergeMapTo(caught$)))), operators.scan((prev, next) => _objectSpread(_objectSpread(_objectSpread({}, prev), next), {}, {
    onRetry
  })));
};
...
//# sourceMappingURL=index-ec45ddb8.js.map
