...
function checkStudioDependencyVersions(workDir) {
  ...
  const dependencies = _objectSpread(_objectSpread({}, manifest.dependencies), manifest.devDependencies);
...
async function readPackageManifest(packageJsonPath) {
  ...
  let manifest;
  try {
    manifest = _objectSpread(_objectSpread({}, defaults), await readPackageJson(packageJsonPath));
  } catch (err) {
...
//# sourceMappingURL=timing-a407497b.js.map
