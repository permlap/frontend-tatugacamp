...
const _excluded = ["childId", "childPayload", "childParameters"],
  _excluded2 = ["documentId", "documentType", "parentRefPath", "children", "template"],
  _excluded3 = ["params", "payload"],
  _excluded4 = ["children", "currentMinWidth", "currentMaxWidth", "flex", "id", "minWidth", "maxWidth", "selected"],
  _excluded5 = ["as", "children", "overflow", "padding"],
  _excluded6 = ["intent"];
...
function PaneItemPreview(props) {
  ...
  return /* @__PURE__ */jsx(SanityDefaultPreview, _objectSpread(_objectSpread({}, getPreviewValueWithFallback({
    value,
    draft,
    published
  })), {}, {
...
const BackLink = forwardRef(function BackLink2(props, ref) {
  ...
  return /* @__PURE__ */jsx(StateLink, _objectSpread(_objectSpread({}, props), {}, {
    ref,
    state
  }));
});
const ChildLink = forwardRef(function ChildLink2(props, ref) {
  ...
  return /* @__PURE__ */jsx(StateLink, _objectSpread(_objectSpread({}, rest), {}, {
    ref,
    state: {
...
const ReferenceChildLink = forwardRef(function ReferenceChildLink2(_ref6, ref) {
  ...
  return /* @__PURE__ */jsx(ChildLink, _objectSpread(_objectSpread({}, rest), {}, {
    ref,
    childId: documentId,
...
const ParameterizedLink = forwardRef(function ParameterizedLink2(props, ref) {
  ...
  return /* @__PURE__ */jsx(StateLink, _objectSpread(_objectSpread({
    ref
  }, rest), {}, {
    state: nextState
  }));
...
function ReferencePreviewLink(props) {
  ...
  const Link = useCallback(function LinkComponent(linkProps) {
    return /* @__PURE__ */jsx(ReferenceChildLink, _objectSpread({
      ...
      children: /* @__PURE__ */jsxs(Flex, {
        ...
        children: [internalReferences.totalCount > 0 && /* @__PURE__ */jsxs(Stack, {
          ...
          children: [internalReferences == null ? void 0 : internalReferences.references.map(item => /* @__PURE__ */jsx(Box, {
            ...
            as: "li",
            padding: 3,
            children: /* @__PURE__ */jsx(OtherReferenceCount, _objectSpread({}, internalReferences))
          })]
          ...
          children: [/* @__PURE__ */jsx(CrossDatasetReferencesSummary, {
            ...
            children: [/* @__PURE__ */jsxs(Table, {
              ...
              padding: 2,
              children: /* @__PURE__ */jsx(OtherReferenceCount, _objectSpread({}, crossDatasetReferences))
            })]
          })]
        })]
      })
...
function ConfirmDeleteDialogContainer(props) {
  ...
  return error ? /* @__PURE__ */jsx(Dialog, {
    ...
    onCatch: setError,
    children: /* @__PURE__ */jsx(ConfirmDeleteDialog, _objectSpread({}, props))
  });
}
...
function PaneContextMenuButton(props) {
  ...
  return /* @__PURE__ */jsx(MenuButton, {
    ...
    menu: /* @__PURE__ */jsx(Menu, {
      children: groups.map((group, groupIndex) => /* @__PURE__ */jsxs(Fragment$1, {
...
function PaneContextMenuItem(props) {
  ...
  const IntentButtonOrActionButton = forwardRef((linkProps, linkRef) => item.intent ? /* @__PURE__ */jsx(IntentLink, _objectSpread(_objectSpread({}, linkProps), {}, {
  ...
  return /* @__PURE__ */jsxs(Fragment, {
    children: [/* @__PURE__ */jsx(LegacyLayerProvider, {
      ...
      children: /* @__PURE__ */jsx(PaneContext.Provider, {
        value: contextValue,
        children: /* @__PURE__ */jsxs(Root$4, _objectSpread(_objectSpread({
          "data-testid": "pane",
          tone: "inherit",
          hidden,
          id,
...
const PaneContent = forwardRef(function PaneContent2(props, ref) {
  ...
  return /* @__PURE__ */jsx(Root$3, _objectSpread(_objectSpread({
...
const IntentButton = forwardRef(function IntentButton2(props, ref) {
  ...
  const Link = useMemo(() => forwardRef(function Link2(linkProps, linkRef) {
    return /* @__PURE__ */jsx(IntentLink, _objectSpread(_objectSpread({}, linkProps), {}, {
      intent: intent.type,
  ...
  return props.disabled ? /* @__PURE__ */jsx(Button, _objectSpread(_objectSpread({}, props), {}, {
    ...
    role: "link",
    "aria-disabled": "true"
  })) : /* @__PURE__ */jsx(Button, _objectSpread(_objectSpread({}, restProps), {}, {
    as: Link,
    "data-as": "a",
    ref
  }));
  ...
  return /* @__PURE__ */jsx(MenuButton, {
    ...
    menu: /* @__PURE__ */jsxs(Menu, {
      children: [/* @__PURE__ */jsx(Box, {
        ...
        const Link = forwardRef((linkProps, linkRef) => disabled ? /* @__PURE__ */jsx("button", _objectSpread(_objectSpread({
          type: "button",
          disabled: true
        }, linkProps), {}, {
          ref: linkRef
        })) : /* @__PURE__ */jsx(IntentLink, _objectSpread(_objectSpread({}, linkProps), {}, {
          intent: intent.type,
          params: intent.params,
          ref: linkRef
        })));
...
const deskTool = definePlugin(options => ({
  ...
  tools: [{
    ...
    component: lazy(() => import('./index-71beeb8c.esm.js').then(function (n) {
      return n.i;
    })),
...
function DeskToolProvider(_ref34) {
  ...
  const rootPaneNode = useMemo(() => {
    if (resolveStructure) return resolveStructure(S, _objectSpread(_objectSpread({}, configContext), {}, {
      documentStore
    }));
    return S.defaults();
...
export { getOrderingMenuItemsForSchemaType as $, DocumentListBuilder as A, BackLink as B, ChildLink as C, DeskToolContext as D, getTypeNamesFromFilter as E, DocumentListItemBuilder as F, isDocumentListItem as G, HistoryRestoreAction as H, DocumentTypeListBuilder as I, shallowIntentChecker as J, GenericListBuilder as K, LOADING_PANE as L, InitialValueTemplateItemBuilder as M, defaultInitialValueTemplateItems as N, maybeSerializeInitialValueTemplateItem as O, ParameterizedLink as P, menuItemsFromInitialValueTemplateItems as Q, ReferenceChildLink as R, SerializeError as S, DEFAULT_INTENT_HANDLER as T, defaultIntentChecker as U, ListBuilder as V, ListItemBuilder as W, maybeSerializeMenuItem as X, MenuItemBuilder as Y, getOrderingMenuItem as Z, _DEBUG as _, PaneRouterContext as a, maybeSerializeMenuItemGroup as a0, MenuItemGroupBuilder as a1, HELP_URL as a2, createStructureBuilder as a3, form as a4, component as a5, FormViewBuilder as a6, ComponentViewBuilder as a7, GenericViewBuilder as a8, maybeSerializeView as a9, PANE_DEFAULT_MIN_WIDTH as b, PANE_COLLAPSED_WIDTH as c, PaneLayoutContext as d, Root as e, Pane as f, PaneHeader as g, PaneContent as h, usePaneRouter as i, DocumentPaneContext as j, usePane as k, DocTitle as l, PaneContextMenuButton as m, usePaneLayout as n, PaneFooter as o, DeskToolProvider as p, PaneHeaderActions as q, PaneItemPreview as r, setActivePanes as s, ConfirmDeleteDialogContainer as t, useDocumentPane as u, deskTool as v, ComponentBuilder as w, DocumentBuilder as x, documentFromEditor as y, documentFromEditorWithInitialValue as z };
//# sourceMappingURL=desk-e211a9df.esm.js.map
