...
async function getBuildAction() {
  const mod = await import('./buildAction-2101540a.esm.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-da390c7e.esm.js');
...
const undeployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./undeployAction-fbb2dd82.esm.js');
    return mod.default(args, context);
  },
  helpText: helpText$m
};
...
const exportDatasetCommand = {
  ...
  action: async (args, context) => {
    ...
    try {
      await exportDataset(_objectSpread({
        client,
        dataset,
        outputPath,
        onProgress
...
async function getDevAction() {
  const mod = await import('./devAction-1f762254.esm.js');
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await import('./previewAction-cee5399d.esm.js');
  return mod.default;
}
...
const execCommand = {
  ...
  helpText: helpText$8,
  action: async (args, context) => {
    const mod = await import('./execScript-8614ec34.esm.js');
    return mod.default(args, context);
  }
};
const corsGroup = {
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-da4e1e23.esm.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-7364c559.esm.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deleteApiAction-cc2a8ad2.esm.js');
    return mod.default(args, context);
  },
  helpText: helpText$2
};
...
export { cliProjectCommands as c, debug as d };
//# sourceMappingURL=_internal-952b2748.esm.js.map
