...
import { useElementRect, Card, Flex, Spinner, Box, Text, Container, Heading, Stack, Label, Code, Button, _raf2, useToast, AvatarStack, MenuItem, Menu, Popover, useClickOutside, BoundaryElementProvider, rem, TextInput, Dialog, TabList, Tab, TabPanel, MenuButton, Inline, usePortal, PortalProvider, useLayer, useGlobalKeyDown, Grid, Tooltip, Hotkeys, LayerProvider, Badge, DialogProvider, useMediaIndex, ErrorBoundary } from '@sanity/ui';
import { C as ChildLink, B as BackLink, R as ReferenceChildLink, P as ParameterizedLink, a as PaneRouterContext, b as PANE_DEFAULT_MIN_WIDTH, c as PANE_COLLAPSED_WIDTH, d as PaneLayoutContext, e as Root$6, D as DeskToolContext, L as LOADING_PANE, S as SerializeError, f as Pane, g as PaneHeader, h as PaneContent, u as useDocumentPane, i as usePaneRouter, j as DocumentPaneContext, k as usePane, l as DocTitle, m as PaneContextMenuButton, n as usePaneLayout, H as HistoryRestoreAction, o as PaneFooter, s as setActivePanes, p as DeskToolProvider } from './desk-e211a9df.esm.js';
import omit from 'lodash/omit.js';
import { switchMap, publishReplay, refCount, first, map, startWith, pairwise, scan, distinctUntilChanged, mapTo, delay, debounceTime, catchError, tap } from 'rxjs/operators';
import { nanoid } from 'nanoid';
import { from, of, NEVER, concat, ReplaySubject, merge } from 'rxjs';
...
const RenderBadgeCollectionState = props => {
  ...
  return /* @__PURE__ */jsx(GetHookCollectionState, _objectSpread(_objectSpread({}, rest), {}, {
    hooks: badges,
    args: badgeProps,
    children
  }));
...
function PaneLayout(props) {
  ...
  return /* @__PURE__ */jsx(PaneLayoutContext.Provider, {
    value: paneLayout,
    children: /* @__PURE__ */jsx(Root$6, _objectSpread(_objectSpread({
      "data-ui": "PaneLayout"
    }, restProps), {}, {
...
function createResolvedPaneNodeStream(_ref6) {
  ...
  return resolvedPanes$.pipe(scan((prev, next) => next.map((nextPane, index) => {
      ...
      children: [/* @__PURE__ */jsx(Heading, {
        ...
        children: [path.length > 0 && /* @__PURE__ */jsxs(Stack, {
          ...
          children: [/* @__PURE__ */jsx(Label, {
            ...
            children: path.slice(1).map((segment, i) => /* @__PURE__ */jsx(PathSegment, {
              children: segment
...
const paneMap = {
  component: lazy(() => import('./index-5af9f947.esm.js')),
  document: lazy(() => import('./index-2c7f4ac3.esm.js')),
  documentList: lazy(() => import('./index-a58953fd.esm.js')),
  list: lazy(() => import('./index-27396ecb.esm.js'))
};
...
function usePreviewUrl(value) {
  ...
  if (error) throw error;
  useEffect(() => {
    value$.pipe(debounceTime(500), switchMap(document => isSanityDocument(document) ? from(resolveProductionUrl({
      document
...
const Root$4 = styled(Box)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  overflow: auto;\n  -webkit-overflow-scrolling: touch;\n"])));
const StackWrapper = styled(Stack)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  max-width: 200px;\n"])));
const MenuWrapper = styled(Menu)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  overflow: auto;\n  box-sizing: border-box;\n  max-height: calc(100vh - 198px);\n"])));
...
const Root$3 = styled(Popover)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  & > div {\n    display: flex;\n    flex-direction: column;\n\n    & > [data-ui='Card'] {\n      flex: 1;\n      min-height: 0;\n      display: flex;\n      flex-direction: column;\n\n      /* This is the scrollable container rendered by <Timeline /> */\n      & > div {\n        flex: 1;\n        min-height: 0;\n      }\n    }\n  }\n"])));
function TimelineMenu(_ref21) {
  ...
  const content = open && /* @__PURE__ */jsx("div", {
    ref: setMenuContent,
    children: mode === "rev" ? /* @__PURE__ */jsx(Timeline, _objectSpread({
      onSelect: selectRev,
      onLoadMore: loadMoreHistory,
      timeline
    }, revTimelineProps(historyController.realRevChunk))) : /* @__PURE__ */jsx(Timeline, _objectSpread({
...
const Scroller$1 = styled(ScrollContainer)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  height: 100%;\n  overflow: auto;\n  position: relative;\n  scroll-behavior: smooth;\n"])));
...
const JSONInspectorWrapper = styled.div(_ref24 => {
  let {
    theme
  } = _ref24;
  const {
...
const Root$2 = styled(Card)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  position: relative;\n  z-index: 50;\n"])));
const TextOneLine = styled(Text)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  & > * {\n    overflow: hidden;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n  }\n"])));
...
const Root$1 = styled(Card)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  position: relative;\n  z-index: 50;\n"])));
...
function ValidationMenu(props) {
  ...
  return /* @__PURE__ */jsx(MenuButton, {
    id: id || "",
    button: /* @__PURE__ */jsx(Button, _objectSpread(_objectSpread({}, buttonProps), {}, {
...
const DocumentPanelHeader = memo(forwardRef((_ref27, ref) => {
  let {
    rootElement
  } = _ref27;
  const {
...
const Scroller = styled(ScrollContainer)(_ref28 => {
  let {
    $disabled
  } = _ref28;
  if ($disabled) {
...
const HistoryStatusBarActions = memo(function HistoryStatusBarActions2() {
  ...
  const actionProps = useMemo(() => _objectSpread(_objectSpread({}, editState || {}), {}, {
    revision
  }), [editState, revision]);
...
const Root = styled(Flex)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  cursor: default;\n"])));
...
const StyledMotionPath = styled(motion.path)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  transform-origin: center;\n"])));
const Circle = props => /* @__PURE__ */jsx(motion.circle, _objectSpread({
  fill: "none",
  r: "8",
  cx: "12.5",
  cy: "12.5",
...
const Arrows = props => /* @__PURE__ */jsx(StyledMotionPath, _objectSpread({
  fill: "none",
  d: "M14 17.5619L11.5 20.5L14.5 23.0619M11 7.43811L13.5 4.50001L10.5 1.93811"
}, props));
const Checkmark = props => /* @__PURE__ */jsx(motion.path, _objectSpread({
  d: "M9.5 12.1316L11.7414 14.5L16 10"
}, props));
const Edit = props => /* @__PURE__ */jsx(motion.path, _objectSpread({
  d: "M15 7L18 10M6 19L7 15L17 5L20 8L10 18L6 19Z"
}, props));
const rotateAnimation = keyframes(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  0% {\n    transform: rotate(0);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n"])));
const RotateGroup = styled.g(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  transform-origin: center;\n\n  &[data-rotate] {\n    animation: ", " 1s ease-in-out infinite;\n  }\n"])), rotateAnimation);
const root = {
  syncing: {
    scale: 1,
    transition: {
...
const DocumentActionsBox = styled(Box)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  min-width: 10em;\n  max-width: 16em;\n"])));
...
const DocumentActionShortcuts = React.memo(props => {
  ...
  const actionProps = useMemo(() => editState && _objectSpread(_objectSpread({}, editState), {}, {
    onComplete: () => void 0,
    revision: void 0
  }), [editState]);
  ...
  return /* @__PURE__ */jsx(RenderActionCollectionState, {
    ...
    children: _ref33 => {
      ...
      return /* @__PURE__ */jsx(KeyboardShortcutResponder, _objectSpread(_objectSpread({}, rest), {}, {
        activeIndex,
        actionsBoxElement,
        onActionStart,
        states,
...
const StyledChangeConnectorRoot = styled(ChangeConnectorRoot)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  flex: 1;\n  display: flex;\n  min-height: 0;\n  min-width: 0;\n"])));
const DocumentPane = memo(function DocumentPane2(props) {
  ...
  return /* @__PURE__ */jsx(SourceProvider, {
    ...
    children: /* @__PURE__ */jsx(DocumentPaneInner, _objectSpread({}, props))
  });
});
function DocumentPaneInner(props) {
  ...
  return /* @__PURE__ */jsx(DocumentPaneProvider, _objectSpread(_objectSpread({}, providerProps), {}, {
...
const StyledPaneLayout = styled(PaneLayout)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  min-height: 100%;\n  min-width: 320px;\n"])));
const isSaveHotkey = isHotkey("mod+s");
const DeskTool = memo(function DeskTool2(_ref34) {
  let {
    onPaneChange
  } = _ref34;
  var _a;
...
export { DocumentPane as D, DocumentPaneProvider as a, Delay as b, useDeskToolSetting as c, index as i, useDeskTool as u };
//# sourceMappingURL=index-71beeb8c.esm.js.map
