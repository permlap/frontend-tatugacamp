...
var exportDataset__default = /*#__PURE__*/_interopDefaultLegacy(exportDataset);
var fs__default$1 = /*#__PURE__*/_interopDefaultLegacy(fs$2);
var getIt__default = /*#__PURE__*/_interopDefaultLegacy(getIt);
var sanityImport__default = /*#__PURE__*/_interopDefaultLegacy(sanityImport);
...
var noop__default = /*#__PURE__*/_interopDefaultLegacy(noop$1);
...
async function getBuildAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./buildAction-cb34042f.js');
  });
  return mod.default;
}
const checkCommand = {
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployAction-54115de2.js');
    });
...
const undeployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./undeployAction-54b81b9d.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$m
...
const exportDatasetCommand = {
  ...
  action: async (args, context) => {
    ...
    try {
      await exportDataset__default["default"](_objectSpread({
        client,
        dataset,
        outputPath,
        onProgress
...
async function getDevAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./devAction-f082a010.js');
  });
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await Promise.resolve().then(function () {
    return require('./previewAction-b80a2deb.js');
  });
  return mod.default;
}
...
const listHookLogsCommand = {
  ...
  action: async (args, context) => {
    ...
    const populated = messages.map(msg => _objectSpread(_objectSpread({}, msg), {}, {
...
const execCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./execScript-6f579c4d.js');
    });
    return mod.default(args, context);
  }
};
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-7cc13b86.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$4
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-0a546d3b.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$3
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deleteApiAction-1f908d40.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$2
...
const listUsersCommand = {
  ...
  action: async (args, context) => {
    ...
    const projectMembers = project.members.map(member => _objectSpread(_objectSpread({}, member), getUserProps(users.find(candidate => candidate.id === member.id)))).filter(member => !member.isRobot || robots);
...
exports.debug = debug;
//# sourceMappingURL=_internal-ca5bebdb.js.map
