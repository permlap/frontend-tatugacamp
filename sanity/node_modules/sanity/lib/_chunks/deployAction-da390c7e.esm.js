...
import buildSanityStudio from './buildAction-2101540a.esm.js';
import 'util';
import '@sanity/server';
import 'chalk';
import 'rimraf';
import './timing-033daeeb.esm.js';
import 'semver';
import 'resolve-from';
...
async function deployStudio(args, context) {
  ...
  if (shouldBuild) {
    ...
    const {
      didCompile
    } = await buildSanityStudio(_objectSpread(_objectSpread({}, args), {}, {
      extOptions: flags,
...
//# sourceMappingURL=deployAction-da390c7e.esm.js.map
