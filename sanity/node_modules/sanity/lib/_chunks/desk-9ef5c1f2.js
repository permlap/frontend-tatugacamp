...
const getVisiblePoll$ = () => {
  if (!visiblePoll$) {
    visiblePoll$ = rxjs.fromEvent(document, "visibilitychange").pipe(operators.startWith(null), operators.map(() => document.visibilityState === "visible"), operators.distinctUntilChanged(), operators.switchMap(visible => visible ? rxjs.timer(0, POLL_INTERVAL) : rxjs.EMPTY), operators.shareReplay({
      refCount: true,
      bufferSize: 1
    }));
  }
...
function PaneItemPreview(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(sanity.SanityDefaultPreview, _objectSpread(_objectSpread({}, sanity.getPreviewValueWithFallback({
    value,
    draft,
    published
  })), {}, {
...
const BackLink = React.forwardRef(function BackLink2(props, ref) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(router$1.StateLink, _objectSpread(_objectSpread({}, props), {}, {
    ref,
    state
  }));
});
const ChildLink = React.forwardRef(function ChildLink2(props, ref) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(router$1.StateLink, _objectSpread(_objectSpread({}, rest), {}, {
    ref,
    state: {
...
const ReferenceChildLink = React.forwardRef(function ReferenceChildLink2(_ref6, ref) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ChildLink, _objectSpread(_objectSpread({}, rest), {}, {
    ref,
    childId: documentId,
...
const ParameterizedLink = React.forwardRef(function ParameterizedLink2(props, ref) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(router$1.StateLink, _objectSpread(_objectSpread({
    ref
  }, rest), {}, {
    state: nextState
  }));
...
function ReferencePreviewLink(props) {
  ...
  const Link = React.useCallback(function LinkComponent(linkProps) {
    return /* @__PURE__ */jsxRuntime.jsx(ReferenceChildLink, _objectSpread({
...
function ConfirmDeleteDialogBody(_ref10) {
  ...
  if ((internalReferences == null ? void 0 : internalReferences.totalCount) === 0 && (crossDatasetReferences == null ? void 0 : crossDatasetReferences.totalCount) === 0) {
    return /* @__PURE__ */jsxRuntime.jsxs(ui.Text, {
      as: "p",
      children: ["Are you sure you want to delete ", /* @__PURE__ */jsxRuntime.jsxs("strong", {
      ...
      children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
        ...
        children: [internalReferences.totalCount > 0 && /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
          ...
          children: [internalReferences == null ? void 0 : internalReferences.references.map(item => /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
            ...
            as: "li",
            padding: 3,
            children: /* @__PURE__ */jsxRuntime.jsx(OtherReferenceCount, _objectSpread({}, internalReferences))
          })]
          ...
          children: [/* @__PURE__ */jsxRuntime.jsx(CrossDatasetReferencesSummary, {
            ...
            children: [/* @__PURE__ */jsxRuntime.jsxs(Table, {
              ...
              padding: 2,
              children: /* @__PURE__ */jsxRuntime.jsx(OtherReferenceCount, _objectSpread({}, crossDatasetReferences))
            })]
          })]
        })]
      })
...
function ConfirmDeleteDialogContainer(props) {
  ...
  return error ? /* @__PURE__ */jsxRuntime.jsx(ui.Dialog, {
    ...
    onCatch: setError,
    children: /* @__PURE__ */jsxRuntime.jsx(ConfirmDeleteDialog, _objectSpread({}, props))
  });
}
...
function PaneContextMenuButton(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.MenuButton, {
    ...
    menu: /* @__PURE__ */jsxRuntime.jsx(ui.Menu, {
      children: groups.map((group, groupIndex) => /* @__PURE__ */jsxRuntime.jsxs(React.Fragment, {
...
function PaneContextMenuItem(props) {
  ...
  const IntentButtonOrActionButton = React.forwardRef((linkProps, linkRef) => item.intent ? /* @__PURE__ */jsxRuntime.jsx(router$1.IntentLink, _objectSpread(_objectSpread({}, linkProps), {}, {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/* @__PURE__ */jsxRuntime.jsx(sanity.LegacyLayerProvider, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(PaneContext.Provider, {
        value: contextValue,
        children: /* @__PURE__ */jsxRuntime.jsxs(Root$4, _objectSpread(_objectSpread({
          "data-testid": "pane",
          tone: "inherit",
          hidden,
          id,
...
const PaneContent = React.forwardRef(function PaneContent2(props, ref) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(Root$3, _objectSpread(_objectSpread({
...
const IntentButton = React.forwardRef(function IntentButton2(props, ref) {
  ...
  const Link = React.useMemo(() => React.forwardRef(function Link2(linkProps, linkRef) {
    return /* @__PURE__ */jsxRuntime.jsx(router$1.IntentLink, _objectSpread(_objectSpread({}, linkProps), {}, {
      intent: intent.type,
  ...
  return props.disabled ? /* @__PURE__ */jsxRuntime.jsx(ui.Button, _objectSpread(_objectSpread({}, props), {}, {
    ...
    role: "link",
    "aria-disabled": "true"
  })) : /* @__PURE__ */jsxRuntime.jsx(ui.Button, _objectSpread(_objectSpread({}, restProps), {}, {
    as: Link,
    "data-as": "a",
    ref
  }));
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.MenuButton, {
    ...
    menu: /* @__PURE__ */jsxRuntime.jsxs(ui.Menu, {
      children: [/* @__PURE__ */jsxRuntime.jsx(ui.Box, {
        ...
        const Link = React.forwardRef((linkProps, linkRef) => disabled ? /* @__PURE__ */jsxRuntime.jsx("button", _objectSpread(_objectSpread({
          type: "button",
          disabled: true
        }, linkProps), {}, {
          ref: linkRef
        })) : /* @__PURE__ */jsxRuntime.jsx(router$1.IntentLink, _objectSpread(_objectSpread({}, linkProps), {}, {
          intent: intent.type,
          params: intent.params,
          ref: linkRef
        })));
...
const router = router$1.route.create("/", [router$1.route.intents("/intent"), router$1.route.create("/edit/:type/:editDocumentId", [router$1.route.create({
  path: "/:params",
  transform: {
    params: {
...
function parsePanesSegment(str) {
  ...
  return str.split(";").map(group => {
    ...
    return [firstSibling, ...restOfSiblings.map(sibling => _objectSpread(_objectSpread(_objectSpread({}, firstSibling), sibling), {}, {
      ...
      params: _objectSpread(_objectSpread({}, omit__default["default"](firstSibling.params, exclusiveParams)), sibling.params),
...
const deskTool = sanity.definePlugin(options => ({
  ...
  tools: [{
    ...
    component: React.lazy(() => Promise.resolve().then(function () {
      return require('./index-4edba1d4.js');
    }).then(function (n) {
      return n.index;
    })),
...
function getDocumentTypeList(context, typeNameOrSpec) {
  ...
  return new DocumentTypeListBuilder(context).id(spec.id || typeName).title(spec.title || title).filter("_type == $type").params({
    ...
    schemaType: typeName,
    documentId
  }))).canHandleIntent(spec.canHandleIntent || defaultIntentChecker).menuItems(spec.menuItems || [...getOrderingMenuItemsForSchemaType(context, type), new MenuItemBuilder(context).group("layout").title("Compact view").icon(icons.StackCompactIcon).action("setLayout").params({
    layout: "default"
...
//# sourceMappingURL=desk-9ef5c1f2.js.map
