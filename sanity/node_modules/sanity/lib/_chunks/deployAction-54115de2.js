...
var buildAction = require('./buildAction-cb34042f.js');
require('util');
require('@sanity/server');
require('chalk');
require('rimraf');
require('./timing-a407497b.js');
require('semver');
...
async function deployStudio(args, context) {
  ...
  if (shouldBuild) {
    ...
    const {
      didCompile
    } = await buildAction["default"](_objectSpread(_objectSpread({}, args), {}, {
      extOptions: flags,
...
//# sourceMappingURL=deployAction-54115de2.js.map
