...
import React, { useContext, useCallback, forwardRef, useMemo, useState, useEffect } from 'react';
...
const IntentLink = forwardRef(function IntentLink2(props, ref) {
  ...
  return /* @__PURE__ */jsx("a", _objectSpread(_objectSpread({}, restProps), {}, {
    href,
    onClick,
    ref,
    target
...
function RouteScope(props) {
  ...
  const scopedRouter = useMemo(() => _objectSpread(_objectSpread({}, parent), {}, {
    navigate,
