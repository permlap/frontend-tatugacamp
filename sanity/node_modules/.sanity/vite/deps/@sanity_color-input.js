import {
  ...
  unset,
  useTheme
} from "./chunk-NPH5VI2L.js";
import {
  require_jsx_runtime
} from "./chunk-WPGOMDEV.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-KJVSR36N.js";
...
var require_alpha = __commonJS({
  "node_modules/react-color/lib/helpers/alpha.js"(exports2) {
    ...
    var calculateChange7 = exports2.calculateChange = function calculateChange8(e2, hsl, direction, initialA, container) {
...
var require_Alpha = __commonJS({
  "node_modules/react-color/lib/components/common/Alpha.js"(exports2) {
    ...
    var Alpha2 = exports2.Alpha = function(_ref) {
      _inherits9(Alpha3, _ref);
      function Alpha3() {
        var _ref2;
        var _temp, _this, _ret;
        _classCallCheck9(this, Alpha3);
        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        return _ret = (_temp = (_this = _possibleConstructorReturn9(this, (_ref2 = Alpha3.__proto__ || Object.getPrototypeOf(Alpha3)).call.apply(_ref2, [this].concat(args))), _this), _this.handleChange = function(e2) {
...
var require_EditableInput = __commonJS({
  "node_modules/react-color/lib/components/common/EditableInput.js"(exports2) {
    ...
    var EditableInput2 = exports2.EditableInput = function(_ref) {
      _inherits9(EditableInput3, _ref);
      function EditableInput3(props) {
        _classCallCheck9(this, EditableInput3);
        var _this = _possibleConstructorReturn9(this, (EditableInput3.__proto__ || Object.getPrototypeOf(EditableInput3)).call(this));
        ...
        _this.handleKeyDown = function(e2) {
          var value = getNumberValue3(e2.target.value);
          if (!isNaN(value) && isValidKeyCode3(e2.keyCode)) {
            var offset = _this.getArrowOffset();
            var updatedValue = e2.keyCode === UP_KEY_CODE2 ? value + offset : value - offset;
...
var require_hue = __commonJS({
  "node_modules/react-color/lib/helpers/hue.js"(exports2) {
    ...
    var calculateChange7 = exports2.calculateChange = function calculateChange8(e2, direction, hsl, container) {
      var containerWidth = container.clientWidth;
      var containerHeight = container.clientHeight;
      var x = typeof e2.pageX === "number" ? e2.pageX : e2.touches[0].pageX;
      var y = typeof e2.pageY === "number" ? e2.pageY : e2.touches[0].pageY;
...
var require_Hue = __commonJS({
  "node_modules/react-color/lib/components/common/Hue.js"(exports2) {
    ...
    var Hue2 = exports2.Hue = function(_ref) {
      _inherits9(Hue3, _ref);
      function Hue3() {
        var _ref2;
        var _temp, _this, _ret;
        _classCallCheck9(this, Hue3);
        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        return _ret = (_temp = (_this = _possibleConstructorReturn9(this, (_ref2 = Hue3.__proto__ || Object.getPrototypeOf(Hue3)).call.apply(_ref2, [this].concat(args))), _this), _this.handleChange = function(e2) {
...
var require_saturation = __commonJS({
  "node_modules/react-color/lib/helpers/saturation.js"(exports2) {
    ...
    var calculateChange7 = exports2.calculateChange = function calculateChange8(e2, hsl, container) {
...
var require_Saturation = __commonJS({
  "node_modules/react-color/lib/components/common/Saturation.js"(exports2) {
    ...
    var Saturation2 = exports2.Saturation = function(_ref) {
      _inherits9(Saturation3, _ref);
      function Saturation3(props) {
        _classCallCheck9(this, Saturation3);
        var _this = _possibleConstructorReturn9(this, (Saturation3.__proto__ || Object.getPrototypeOf(Saturation3)).call(this, props));
        _this.handleChange = function(e2) {
        ...
        _this.throttle = (0, _throttle2.default)(function(fn, data, e2) {
          fn(data, e2);
        }, 50);
        return _this;
      }
      _createClass9(Saturation3, [{
        key: "componentWillUnmount",
        value: function componentWillUnmount() {
    ...
    (function(Math2) {
      ...
      tinycolor2.prototype = {
        ...
        toHsvString: function() {
          var hsv = rgbToHsv(this._r, this._g, this._b);
          var h2 = mathRound(hsv.h * 360), s2 = mathRound(hsv.s * 100), v = mathRound(hsv.v * 100);
      ...
      function rgbToHsl(r, g2, b2) {
        ...
        g2 = bound01(g2, 255);
        b2 = bound01(b2, 255);
        var max = mathMax(r, g2, b2), min = mathMin(r, g2, b2);
      ...
      function hsvToRgb(h2, s2, v) {
        ...
        s2 = bound01(s2, 100);
        v = bound01(v, 100);
        var i = Math2.floor(h2), f = h2 - i, p2 = v * (1 - s2), q2 = v * (1 - f * s2), t = v * (1 - (1 - f) * s2), mod = i % 6, r = [v, q2, p2, p2, t, v][mod], g2 = [t, v, v, q2, p2, p2][mod], b2 = [p2, p2, t, v, v, q2][mod];
        return { r: r * 255, g: g2 * 255, b: b2 * 255 };
      }
      ...
      function rgbaToArgbHex(r, g2, b2, a) {
        var hex = [
          pad2(convertDecimalToHex(a)),
          pad2(mathRound(r).toString(16)),
          pad2(mathRound(g2).toString(16)),
      ...
      function monochromatic(color, results) {
        ...
        while (results--) {
          ret.push(tinycolor2({ h: h2, s: s2, v }));
          v = (v + modification) % 1;
        }
        return ret;
      }
...
var require_color = __commonJS({
  "node_modules/react-color/lib/helpers/color.js"(exports2) {
    ...
    var isValidHex3 = exports2.isValidHex = function isValidHex4(hex) {
      if (hex === "transparent") {
        return true;
      }
  ...
  "node_modules/react-color/lib/components/common/ColorWrap.js"(exports2) {
    ...
    var ColorWrap3 = exports2.ColorWrap = function ColorWrap4(Picker) {
      var ColorPicker = function(_ref) {
        _inherits9(ColorPicker2, _ref);
        function ColorPicker2(props) {
          _classCallCheck9(this, ColorPicker2);
          var _this = _possibleConstructorReturn9(this, (ColorPicker2.__proto__ || Object.getPrototypeOf(ColorPicker2)).call(this));
          ...
          _this.state = _extends10({}, color.toState(props.color, 0));
          _this.debounce = (0, _debounce2.default)(function(fn, data, event) {
            fn(data, event);
          }, 100);
          return _this;
        }
        _createClass9(ColorPicker2, [{
          key: "render",
          value: function render3() {
            var optionalEvents = {};
          ...
          value: function getDerivedStateFromProps(nextProps, state) {
            return _extends10({}, color.toState(nextProps.color, state.oldHue));
          }
        }]);
        return ColorPicker2;
      }(_react.PureComponent || _react.Component);
      ColorPicker.propTypes = _extends10({}, Picker.propTypes);
      ColorPicker.defaultProps = _extends10({}, Picker.defaultProps, {
        color: {
          h: 250,
          s: 0.5,
          l: 0.2,
  ...
  "node_modules/react-color/lib/components/common/Swatch.js"(exports2) {
    ...
    var Swatch3 = exports2.Swatch = function Swatch4(_ref) {
      ...
      var handleKeyDown = function handleKeyDown2(e2) {
        return e2.keyCode === ENTER2 && onClick(color, e2);
      };
...
// node_modules/@sanity/color-input/node_modules/@sanity/icons/dist/index.js
...
var AccessDeniedIcon = (0, import_react.forwardRef)(function AccessDeniedIcon2(props, ref) {
  return (0, import_jsx_runtime.jsx)("svg", _objectSpread(_objectSpread({
...
var ApiIcon = (0, import_react.forwardRef)(function ApiIcon2(props, ref) {
  return (0, import_jsx_runtime.jsxs)("svg", _objectSpread(_objectSpread({
...
var Icon = (0, import_react.forwardRef)(function Icon2(props, ref) {
  ...
  return (0, import_react.createElement)(iconComponent, _objectSpread(_objectSpread({}, restProps), {}, {
    ref
  }));
});
...
var Checkboard = function Checkboard2(_ref) {
  ...
  return (0, import_react2.isValidElement)(children) ? import_react2.default.cloneElement(children, _extends({}, children.props, { style: _extends({}, children.props.style, styles.grid) })) : import_react2.default.createElement("div", { style: styles.grid });
};
    ...
    value: function render3() {
      ...
      return import_react3.default.createElement(
        ...
        import_react3.default.createElement(
          "div",
          { style: styles.checkboard },
          import_react3.default.createElement(Checkboard_default, { renderers: this.props.renderers })
        ),
        import_react3.default.createElement("div", { style: styles.gradient }),
        import_react3.default.createElement(
          "div",
          {
            style: styles.container,
          ...
          import_react3.default.createElement(
            "div",
            { style: styles.pointer },
            this.props.pointer ? import_react3.default.createElement(this.props.pointer, this.props) : import_react3.default.createElement("div", { style: styles.slider })
          )
        )
      );
    }
  ...
  _createClass2(EditableInput2, [{
    ...
    value: function render3() {
      ...
      return import_react4.default.createElement(
        ...
        this.props.label && !this.props.hideLabel ? import_react4.default.createElement(
          "label",
          {
            htmlFor: this.inputId,
            style: styles.label,
      ...
      return import_react5.default.createElement(
        ...
        import_react5.default.createElement(
          ...
          import_react5.default.createElement(
            "div",
            { style: styles.pointer },
            this.props.pointer ? import_react5.default.createElement(this.props.pointer, this.props) : import_react5.default.createElement("div", { style: styles.slider })
          )
        )
      );
    }
...
var Raised = function Raised2(_ref) {
  ...
  return import_react6.default.createElement(
    "div",
    { style: styles.wrap },
    import_react6.default.createElement("div", { style: styles.bg }),
    ...
    value: function render3() {
      ...
      return import_react7.default.createElement(
        ...
        import_react7.default.createElement(
          "div",
          { style: styles.white, className: "saturation-white" },
          import_react7.default.createElement("div", { style: styles.black, className: "saturation-black" }),
          import_react7.default.createElement(
            "div",
            { style: styles.pointer },
            this.props.pointer ? import_react7.default.createElement(this.props.pointer, this.props) : import_react7.default.createElement("div", { style: styles.circle })
          )
        )
      );
    }
  ...
  var ColorPicker = function(_ref) {
    ...
    _createClass5(ColorPicker2, [{
      ...
      value: function render3() {
        ...
        return import_react8.default.createElement(Picker, _extends3({}, this.props, this.state, {
          onChange: this.handleChange
        }, optionalEvents));
      }
    }], [{
    ...
    _createClass6(Focus, [{
      ...
      value: function render3() {
        return import_react9.default.createElement(
          Span,
          { onFocus: this.handleFocus, onBlur: this.handleBlur },
          import_react9.default.createElement(Component6, _extends4({}, this.props, this.state))
        );
      }
    }]);
    return Focus;
...
var Swatch = function Swatch2(_ref) {
  ...
  return import_react10.default.createElement(
    ...
    children,
    transparent && import_react10.default.createElement(Checkboard_default, {
      borderRadius: styles.swatch.borderRadius,
      boxShadow: "inset 0 0 0 1px rgba(0,0,0,0.1)"
    })
  );
...
var AlphaPointer = function AlphaPointer2(_ref) {
  ...
  return import_react11.default.createElement("div", { style: styles.picker });
};
...
var AlphaPicker = function AlphaPicker2(_ref) {
  ...
  return import_react12.default.createElement(
    ...
    import_react12.default.createElement(Alpha_default, _extends6({}, styles.alpha, {
      rgb,
      hsl,
      pointer,
      renderers,
...
var BlockSwatches = function BlockSwatches2(_ref) {
  ...
  return import_react13.default.createElement(
    ...
    map_default(colors, function(c2) {
      return import_react13.default.createElement(Swatch_default, {
        key: c2,
        color: c2,
        style: styles.swatch,
        onClick,
    ...
    import_react13.default.createElement("div", { style: styles.clear })
  );
};
...
var Block = function Block2(_ref) {
  ...
  return import_react14.default.createElement(
    ...
    import_react14.default.createElement("div", { style: styles.triangle }),
    import_react14.default.createElement(
      "div",
      { style: styles.head },
      transparent && import_react14.default.createElement(Checkboard_default, { borderRadius: "6px 6px 0 0" }),
      import_react14.default.createElement(
        "div",
        { style: styles.label },
        hex
    ...
    import_react14.default.createElement(
      "div",
      { style: styles.body },
      import_react14.default.createElement(BlockSwatches_default, { colors, onClick: handleChange, onSwatchHover }),
      import_react14.default.createElement(EditableInput_default, {
...
var CircleSwatch = function CircleSwatch2(_ref) {
  ...
  return import_react15.default.createElement(
    "div",
    { style: styles.swatch },
    import_react15.default.createElement(Swatch_default, {
      style: styles.Swatch,
      color,
      onClick,
      onHover: onSwatchHover,
...
var Circle = function Circle2(_ref) {
  ...
  return import_react16.default.createElement(
    ...
    map_default(colors, function(c2) {
      return import_react16.default.createElement(CircleSwatch_default, {
        key: c2,
        color: c2,
  ...
  _createClass7(ChromeFields2, [{
    ...
    value: function render3() {
      ...
      if (this.state.view === "hex") {
        fields = import_react17.default.createElement(
          "div",
          { style: styles.fields, className: "flexbox-fix" },
          import_react17.default.createElement(
            "div",
            { style: styles.field },
            import_react17.default.createElement(EditableInput_default, {
      ...
      return import_react17.default.createElement(
        ...
        import_react17.default.createElement(
          ...
          import_react17.default.createElement(
            ...
            import_react17.default.createElement(import_UnfoldMoreHorizontalIcon.default, {
              style: styles.svg,
...
var ChromePointerCircle = function ChromePointerCircle2() {
  ...
  return import_react19.default.createElement("div", { style: styles.picker });
};
...
var Chrome = function Chrome2(_ref) {
  ...
  return import_react20.default.createElement(
    ...
    import_react20.default.createElement(
      ...
      import_react20.default.createElement(Saturation_default, {
        style: styles.Saturation,
        hsl,
        hsv,
    ...
    import_react20.default.createElement(
      ...
      import_react20.default.createElement(
        ...
        import_react20.default.createElement(
          ...
          import_react20.default.createElement(
            "div",
            { style: styles.swatch },
            import_react20.default.createElement("div", { style: styles.active }),
            import_react20.default.createElement(Checkboard_default, { renderers })
          )
        ),
        import_react20.default.createElement(
          "div",
          ...
          import_react20.default.createElement(
            "div",
            { style: styles.hue },
            import_react20.default.createElement(Hue_default, {
              style: styles.Hue,
              hsl,
          ...
          import_react20.default.createElement(
            "div",
            { style: styles.alpha },
            import_react20.default.createElement(Alpha_default, {
              style: styles.Alpha,
              rgb,
              hsl,
              pointer: ChromePointer_default,
      ...
      import_react20.default.createElement(ChromeFields_default, {
        rgb,
        hsl,
        hex,
        view: defaultView,
...
var CompactColor = function CompactColor2(_ref) {
  ...
  return import_react21.default.createElement(
    ...
    import_react21.default.createElement("div", { style: styles.dot })
  );
};
...
var CompactFields = function CompactFields2(_ref) {
  ...
  return import_react22.default.createElement(
    "div",
    { style: styles.fields, className: "flexbox-fix" },
    import_react22.default.createElement("div", { style: styles.active }),
    import_react22.default.createElement(EditableInput_default, {
  ...
  return import_react23.default.createElement(
    ...
    import_react23.default.createElement(
      ...
      import_react23.default.createElement(
        ...
        null,
        map_default(colors, function(c2) {
          return import_react23.default.createElement(CompactColor_default, {
            key: c2,
            color: c2,
        ...
        import_react23.default.createElement("div", { style: styles.clear })
      ),
      import_react23.default.createElement(CompactFields_default, { hex, rgb, onChange: handleChange })
    )
  );
};
Compact.propTypes = {
...
var GithubSwatch = function GithubSwatch2(_ref) {
  ...
  return import_react24.default.createElement(
    "div",
    { style: styles.swatch },
    import_react24.default.createElement(Swatch_default, {
      color,
      onClick,
      onHover: onSwatchHover,
...
var Github = function Github2(_ref) {
  ...
  return import_react25.default.createElement(
    ...
    import_react25.default.createElement("div", { style: styles.triangleShadow }),
    import_react25.default.createElement("div", { style: styles.triangle }),
    map_default(colors, function(c2) {
      return import_react25.default.createElement(GithubSwatch_default, {
        color: c2,
        key: c2,
        onClick: handleChange,
        onSwatchHover
...
var SliderPointer = function SliderPointer2(_ref) {
  ...
  return import_react26.default.createElement("div", { style: styles.picker });
};
...
var HuePicker = function HuePicker2(_ref) {
  ...
  return import_react27.default.createElement(
    ...
    import_react27.default.createElement(Hue_default, _extends7({}, styles.hue, {
      hsl,
      pointer,
      onChange: handleChange,
      direction
...
var PhotoshopPicker = function PhotoshopPicker2(_ref) {
  ...
  return import_react29.default.createElement(
    "div",
    { style: styles.fields },
    import_react29.default.createElement(EditableInput_default, {
      style: { wrap: styles.RGBwrap, input: styles.RGBinput, label: styles.RGBlabel },
      label: "h",
    ...
    import_react29.default.createElement("div", { style: styles.divider }),
    import_react29.default.createElement(EditableInput_default, {
      style: { wrap: styles.RGBwrap, input: styles.RGBinput, label: styles.RGBlabel },
      label: "r",
      value: rgb.r,
...
var PhotoshopPointerCircle3 = function PhotoshopPointerCircle4() {
  ...
  return import_react31.default.createElement(
    ...
    import_react31.default.createElement(
      "div",
      { style: styles.left },
      import_react31.default.createElement("div", { style: styles.leftInside })
    ),
    import_react31.default.createElement(
      "div",
      { style: styles.right },
      import_react31.default.createElement("div", { style: styles.rightInside })
    )
  );
};
...
var PhotoshopPreviews = function PhotoshopPreviews2(_ref) {
  ...
  return import_react33.default.createElement(
    ...
    import_react33.default.createElement(
      "div",
      { style: styles.swatches },
      import_react33.default.createElement("div", { style: styles.new }),
      import_react33.default.createElement("div", { style: styles.current })
    ),
    import_react33.default.createElement(
      "div",
      { style: styles.label },
      ...
      return import_react34.default.createElement(
        ...
        import_react34.default.createElement(
          ...
          import_react34.default.createElement(
            "div",
            { style: styles.saturation },
            import_react34.default.createElement(Saturation_default, {
              hsl: this.props.hsl,
              hsv: this.props.hsv,
          ...
          import_react34.default.createElement(
            "div",
            { style: styles.hue },
            import_react34.default.createElement(Hue_default, {
              direction: "vertical",
              hsl: this.props.hsl,
          ...
          import_react34.default.createElement(
            ...
            import_react34.default.createElement(
              ...
              import_react34.default.createElement(
                ...
                import_react34.default.createElement(PhotoshopPreviews_default, {
                  rgb: this.props.rgb,
              ...
              import_react34.default.createElement(
                ...
                import_react34.default.createElement(PhotoshopButton_default, { label: "OK", onClick: this.props.onAccept, active: true }),
                import_react34.default.createElement(PhotoshopButton_default, { label: "Cancel", onClick: this.props.onCancel }),
                import_react34.default.createElement(PhotoshopFields_default, {
                  onChange: this.props.onChange,
                  rgb: this.props.rgb,
                  hsv: this.props.hsv,
                  hex: this.props.hex
  ...
  return import_react36.default.createElement(
    ...
    colors.map(function(colorObjOrString) {
      ...
      return import_react36.default.createElement(
        ...
        import_react36.default.createElement(Swatch_default, _extends8({}, c2, {
          style: styles.swatch,
          onClick: handleClick,
          onHover: onSwatchHover,
          focusStyle: {
...
var Sketch = function Sketch2(_ref) {
  ...
  return import_react37.default.createElement(
    ...
    import_react37.default.createElement(
      "div",
      { style: styles.saturation },
      import_react37.default.createElement(Saturation_default, {
        style: styles.Saturation,
        hsl,
        hsv,
        onChange
    ...
    import_react37.default.createElement(
      ...
      import_react37.default.createElement(
        ...
        import_react37.default.createElement(
          "div",
          { style: styles.hue },
          import_react37.default.createElement(Hue_default, {
            style: styles.Hue,
            hsl,
            onChange
          })
        ...
        import_react37.default.createElement(
          "div",
          { style: styles.alpha },
          import_react37.default.createElement(Alpha_default, {
            style: styles.Alpha,
            rgb,
            hsl,
            renderers,
      ...
      import_react37.default.createElement(
        "div",
        { style: styles.color },
        import_react37.default.createElement(Checkboard_default, null),
        import_react37.default.createElement("div", { style: styles.activeColor })
      )
    ),
    import_react37.default.createElement(SketchFields_default, {
      rgb,
      hsl,
      hex,
      onChange,
    ...
    import_react37.default.createElement(SketchPresetColors_default, {
      colors: presetColors,
      onClick: onChange,
      onSwatchHover
    })
...
var SliderSwatch = function SliderSwatch2(_ref) {
  ...
  return import_react38.default.createElement("div", { style: styles.swatch, onClick: handleClick });
};
...
var SliderSwatches = function SliderSwatches2(_ref) {
  ...
  return import_react39.default.createElement(
    ...
    import_react39.default.createElement(
      "div",
      { style: styles.swatch },
      import_react39.default.createElement(SliderSwatch_default, {
        hsl,
        offset: ".80",
    ...
    import_react39.default.createElement("div", { style: styles.clear })
  );
};
...
var Slider = function Slider2(_ref) {
  ...
  return import_react41.default.createElement(
    ...
    import_react41.default.createElement(
      "div",
      { style: styles.swatches },
      import_react41.default.createElement(SliderSwatches_default, { hsl, onClick: onChange })
    )
  );
};
Slider.propTypes = {
...
var SwatchesColor = function SwatchesColor2(_ref) {
  ...
  return import_react42.default.createElement(
    ...
    import_react42.default.createElement(
      "div",
      { style: styles.check },
      import_react42.default.createElement(import_CheckIcon.default, null)
    )
  );
};
...
var SwatchesGroup = function SwatchesGroup2(_ref) {
  ...
  return import_react43.default.createElement(
    ...
    map_default(group, function(color, i) {
      return import_react43.default.createElement(SwatchesColor_default, {
        key: color,
        color,
      ...
      import_react44.default.createElement(
        ...
        import_react44.default.createElement(
          ...
          map_default(colors, function(group) {
            return import_react44.default.createElement(SwatchesGroup_default, {
              key: group.toString(),
              group,
              active: hex,
              onClick: handleChange,
...
var Twitter = function Twitter2(_ref) {
  ...
  return import_react45.default.createElement(
    ...
    import_react45.default.createElement(
      "div",
      { style: styles.body },
      map_default(colors, function(c2, i) {
        return import_react45.default.createElement(Swatch_default, {
          key: i,
          color: c2,
          hex: c2,
          style: styles.swatch,
      ...
      import_react45.default.createElement(EditableInput_default, {
        label: null,
        style: { input: styles.input },
        value: hex.replace("#", ""),
        onChange: handleChange
      }),
      import_react45.default.createElement("div", { style: styles.clear })
    )
  );
};
Twitter.propTypes = {
...
var Google = function Google2(_ref) {
  ...
  return import_react49.default.createElement(
    ...
    import_react49.default.createElement("div", { style: styles.swatch }),
    import_react49.default.createElement(
      "div",
      { style: styles.saturation },
      import_react49.default.createElement(Saturation_default, {
        hsl,
        hsv,
    ...
    import_react49.default.createElement(
      ...
      import_react49.default.createElement(
        ...
        import_react49.default.createElement(
          "div",
          { style: styles.hue },
          import_react49.default.createElement(Hue_default, {
            style: styles.Hue,
            hsl,
            radius: "4px",
      ...
      import_react49.default.createElement(GoogleFields_default, {
        rgb,
        hsl,
        hex,
        hsv,
...
var l;
function n(e2, l2) {
  return l2 || (l2 = e2.slice(0)), Object.freeze(Object.defineProperties(e2, { raw: { value: Object.freeze(l2) } }));
}
var T = defineType({ title: "Hue Saturation Lightness", name: "hslaColor", type: "object", fields: [{ name: "h", type: "number", title: "Hue" }, { name: "s", type: "number", title: "Saturation" }, { name: "l", type: "number", title: "Lightness" }, { name: "a", type: "number", title: "Alpha" }] });
var G = defineType({ title: "Red Green Blue (rgb)", name: "rgbaColor", type: "object", fields: [{ name: "r", type: "number", title: "Red" }, { name: "g", type: "number", title: "Green" }, { name: "b", type: "number", title: "Blue" }, { name: "a", type: "number", title: "Alpha" }] });
var V = (e2) => {
  let { onChange: l2, rgb: n2, hsl: t, hex: o, disableAlpha: a } = e2;
  var r;
  const { sanity: i } = useTheme(), s2 = (0, import_react50.useMemo)(() => ({ input: { width: "80%", padding: "4px 10% 3px", border: "none", boxShadow: "inset 0 0 0 1px ".concat(i.color.input.default.enabled.border), color: i.color.input.default.enabled.fg, backgroundColor: i.color.input.default.enabled.bg, fontSize: i.fonts.text.sizes[0].fontSize, textAlign: "center" }, label: { display: "block", textAlign: "center", fontSize: i.fonts.label.sizes[0].fontSize, color: i.color.base.fg, paddingTop: "3px", paddingBottom: "4px", textTransform: "capitalize" } }), [i]), p2 = (0, import_react50.useCallback)((e3) => {
    if ("hex" in e3 && e3.hex && (0, import_color.isValidHex)(e3.hex))
      l2({ hex: e3.hex, source: "hex" });
    else if (n2 && ("r" in e3 && e3.r || "g" in e3 && e3.g || "b" in e3 && e3.b))
      l2({ r: Number(e3.r) || n2.r, g: Number(e3.g) || n2.g, b: Number(e3.b) || n2.b, a: n2.a, source: "rgb" });
    else if (t && "a" in e3 && e3.a) {
      let n3 = Number(e3.a);
      n3 < 0 ? n3 = 0 : n3 > 100 && (n3 = 100), n3 /= 100, l2({ h: t.h, s: t.s, l: t.l, a: n3, source: "hsl" });
    }
  }, [l2, t, n2]);
  return (0, import_jsx_runtime2.jsxs)(Flex, { children: [(0, import_jsx_runtime2.jsx)(Box, { flex: 2, marginRight: 1, children: (0, import_jsx_runtime2.jsx)(import_common26.EditableInput, { style: s2, label: "hex", value: null == o ? void 0 : o.replace("#", ""), onChange: p2 }) }), (0, import_jsx_runtime2.jsx)(Box, { flex: 1, marginRight: 1, children: (0, import_jsx_runtime2.jsx)(import_common26.EditableInput, { style: s2, label: "r", value: null == n2 ? void 0 : n2.r, onChange: p2, dragLabel: true, dragMax: 255 }) }), (0, import_jsx_runtime2.jsx)(Box, { flex: 1, marginRight: 1, children: (0, import_jsx_runtime2.jsx)(import_common26.EditableInput, { style: s2, label: "g", value: null == n2 ? void 0 : n2.g, onChange: p2, dragLabel: true, dragMax: 255 }) }), (0, import_jsx_runtime2.jsx)(Box, { flex: 1, marginRight: 1, children: (0, import_jsx_runtime2.jsx)(import_common26.EditableInput, { style: s2, label: "b", value: null == n2 ? void 0 : n2.b, onChange: p2, dragLabel: true, dragMax: 255 }) }), !a && (0, import_jsx_runtime2.jsx)(Box, { flex: 1, children: (0, import_jsx_runtime2.jsx)(import_common26.EditableInput, { style: s2, label: "a", value: Math.round(100 * (null != (r = null == n2 ? void 0 : n2.a) ? r : 1)), onChange: p2, dragLabel: true, dragMax: 100 }) })] });
};
var _ = styled_components_browser_esm_default(Box)(e || (e = n(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n"])));
var U = styled_components_browser_esm_default(Flex)(l || (l = n(["\n  margin-top: 6rem;\n  background-color: var(--card-bg-color);\n  position: relative;\n  width: 100%;\n"])));
var D = ColorWrap_default((e2) => {
  var l2, n2, t;
  const { width: o, color: { rgb: a, hex: r, hsv: i, hsl: c2 }, onChange: u2, onUnset: p2, disableAlpha: b2, readOnly: m2 } = e2;
  return c2 && i ? (0, import_jsx_runtime2.jsx)("div", { style: { width: o }, children: (0, import_jsx_runtime2.jsx)(Card, { padding: 1, border: true, radius: 1, children: (0, import_jsx_runtime2.jsxs)(Stack, { space: 2, children: [!m2 && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [(0, import_jsx_runtime2.jsx)(Card, { overflow: "hidden", style: { position: "relative", height: "5em" }, children: (0, import_jsx_runtime2.jsx)(import_common26.Saturation, { onChange: u2, hsl: c2, hsv: i }) }), (0, import_jsx_runtime2.jsx)(Card, { shadow: 1, radius: 3, overflow: "hidden", style: { position: "relative", height: "10px" }, children: (0, import_jsx_runtime2.jsx)(import_common26.Hue, { hsl: c2, onChange: !m2 && u2 }) }), !b2 && (0, import_jsx_runtime2.jsx)(Card, { shadow: 1, radius: 3, overflow: "hidden", style: { position: "relative", height: "10px" }, children: (0, import_jsx_runtime2.jsx)(import_common26.Alpha, { rgb: a, hsl: c2, onChange: u2 }) })] }), (0, import_jsx_runtime2.jsxs)(Flex, { children: [(0, import_jsx_runtime2.jsxs)(Card, { flex: 1, radius: 2, overflow: "hidden", style: { position: "relative", minWidth: "4em" }, children: [(0, import_jsx_runtime2.jsx)(import_common26.Checkboard, {}), (0, import_jsx_runtime2.jsx)(_, { style: { backgroundColor: "rgba(".concat(null == a ? void 0 : a.r, ",").concat(null == a ? void 0 : a.g, ",").concat(null == a ? void 0 : a.b, ",").concat(null == a ? void 0 : a.a, ")") } }), m2 && (0, import_jsx_runtime2.jsx)(U, { padding: 2, paddingBottom: 1, sizing: "border", justify: "space-between", children: (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, marginTop: 1, children: [(0, import_jsx_runtime2.jsx)(Text, { size: 3, weight: "bold", children: r }), (0, import_jsx_runtime2.jsxs)(Inline, { space: 3, children: [(0, import_jsx_runtime2.jsxs)(Text, { size: 1, children: [(0, import_jsx_runtime2.jsx)("strong", { children: "RGB: " }), null == a ? void 0 : a.r, " ", null == a ? void 0 : a.g, " ", null == a ? void 0 : a.b] }), (0, import_jsx_runtime2.jsxs)(Text, { size: 1, children: [(0, import_jsx_runtime2.jsx)("strong", { children: "HSL: " }), " ", Math.round(null != (l2 = null == c2 ? void 0 : c2.h) ? l2 : 0), " ", Math.round(null != (n2 = null == c2 ? void 0 : c2.s) ? n2 : 0), "%", " ", Math.round(null != (t = null == c2 ? void 0 : c2.l) ? t : 0)] })] })] }) })] }), !m2 && (0, import_jsx_runtime2.jsxs)(Flex, { align: "flex-start", marginLeft: 2, children: [(0, import_jsx_runtime2.jsx)(Box, { style: { width: 200 }, children: (0, import_jsx_runtime2.jsx)(V, { rgb: a, hsl: c2, hex: r, onChange: u2, disableAlpha: b2 }) }), (0, import_jsx_runtime2.jsx)(Box, { marginLeft: 2, children: (0, import_jsx_runtime2.jsx)(Button, { onClick: p2, title: "Delete color", icon: TrashIcon, tone: "critical" }) })] })] })] }) }) }) : null;
});
var P = { hex: "#24a3e3", hsl: { h: 200, s: 0.7732, l: 0.5156, a: 1 }, hsv: { h: 200, s: 0.8414, v: 0.8901, a: 1 }, rgb: { r: 46, g: 163, b: 227, a: 1 }, source: "hex" };
function W(e2) {
  var l2;
  const { onChange: n2, readOnly: t } = e2, i = e2.value, h2 = e2.schemaType, y = (0, import_react50.useRef)(null), [f, v] = (0, import_react50.useState)(i);
  (0, import_react50.useEffect)(() => v(i), [i]);
  const x = (0, import_react50.useCallback)((e3) => {
    var l3;
    const t2 = h2.fields.filter((l4) => l4.name in e3).map((l4) => {
      const n3 = e3[l4.name], t3 = "object" === l4.type.jsonType;
      return set$2(t3 ? Object.assign({ _type: l4.type.name }, n3) : n3, [l4.name]);
    });
    n2([setIfMissing({ _type: h2.name }), set$2(h2.name, ["_type"]), set$2(null == (l3 = e3.rgb) ? void 0 : l3.a, ["alpha"]), ...t2]);
  }, [n2, h2]), C = (0, import_react50.useMemo)(() => (0, import_lodash.debounce)(x, 100), [x]), w = (0, import_react50.useCallback)((e3) => {
    v(e3), C(e3);
  }, [C, v]), z = (0, import_react50.useCallback)(() => {
    v(P), x(P);
  }, [x]), j = (0, import_react50.useCallback)(() => {
    v(void 0), n2(unset());
  }, [n2]);
  return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: i && i.hex ? (0, import_jsx_runtime2.jsx)(D, { color: f, onChange: w, readOnly: t || "boolean" == typeof h2.readOnly && h2.readOnly, disableAlpha: !!(null == (l2 = h2.options) ? void 0 : l2.disableAlpha), onUnset: j }) : (0, import_jsx_runtime2.jsx)(Button, { icon: AddIcon, mode: "ghost", text: "Create color", ref: y, disabled: Boolean(t), onClick: z }) });
}
var q = function() {
  let e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1;
  return Math.round(100 * e2);
};
var E = defineType({ name: "color", type: "object", title: "Color", components: { input: W }, fields: [{ title: "Hex", name: "hex", type: "string" }, { title: "Alpha", name: "alpha", type: "number" }, { title: "Hue Saturation Lightness", name: "hsl", type: "hslaColor" }, { title: "Hue Saturation Value", name: "hsv", type: "hsvaColor" }, { title: "Red Green Blue (rgb)", name: "rgb", type: "rgbaColor" }], preview: { select: { title: "hex", alpha: "alpha", hex: "hex", hsl: "hsl" }, prepare(e2) {
  let { title: l2, hex: n2, hsl: t, alpha: o } = e2, a = n2 || "No color set";
  return t && (a = "H:".concat(q(t.h), " S:").concat(q(t.s), " L:").concat(q(t.l), " A:").concat(q(o))), { title: l2, subtitle: a, media: () => (0, import_jsx_runtime2.jsx)("div", { style: { backgroundColor: null != n2 ? n2 : "#000", opacity: null != o ? o : 1, position: "absolute", height: "100%", width: "100%", top: "0", left: "0" } }) };
} } });
var F = defineType({ title: "Hue Saturation Value", name: "hsvaColor", type: "object", fields: [{ name: "h", type: "number", title: "Hue" }, { name: "s", type: "number", title: "Saturation" }, { name: "v", type: "number", title: "Value" }, { name: "a", type: "number", title: "Alpha" }] });
var I = definePlugin({ name: "@sanity/color-input", schema: { types: [T, F, G, E] } });
export {
  W as ColorInput,
  E as color,
  I as colorInput,
