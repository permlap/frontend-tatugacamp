import {
  ...
  PlayIcon,
  StopIcon
} from "./chunk-E3GDX7DN.js";
import {
  require_hashlru,
  require_json_inspector
} from "./chunk-GFG4TBPE.js";
import {
  Box,
  Button,
  Card,
...
var require_dist = __commonJS({
  "node_modules/json5/dist/index.js"(exports, module) {
    !function(u, D) {
      ...
      var e = F.Space_Separator, C2 = F.ID_Start, A = F.ID_Continue;
      function r(u2) {
        return u2 >= "a" && u2 <= "z" || u2 >= "A" && u2 <= "Z" || "$" === u2 || "_" === u2 || C2.test(u2);
      }
      function t2(u2) {
      ...
      }, o = void 0, a = void 0, B = void 0, c = void 0, s = void 0, f = void 0, d = void 0, l = void 0, v = void 0;
      ...
      function P(u2) {
        ...
        try {
          for (var C3, A2 = u2[Symbol.iterator](); !(D2 = (C3 = A2.next()).done); D2 = true) {
            var r2 = C3.value;
            if (g() !== r2)
              throw j(S());
            S();
      ...
      return { parse: function(u2, D2) {
        o = String(u2), a = "start", B = [], c = 0, s = 1, f = 0, d = void 0, l = void 0, v = void 0;
        do {
          d = b(), I[a]();
        } while ("eof" !== d.type);
        return "function" == typeof D2 ? function u3(D3, F2, e2) {
          var C3 = D3[F2];
          if (null != C3 && "object" === (void 0 === C3 ? "undefined" : i(C3)))
            for (var A2 in C3) {
              var r2 = u3(C3, A2, e2);
              void 0 === r2 ? delete C3[A2] : C3[A2] = r2;
            }
          return e2.call(D3, F2, C3);
        }({ "": v }, "", D2) : v;
      }, stringify: function(u2, D2, F2) {
        var e2 = [], C3 = "", A2 = void 0, E2 = void 0, n2 = "", o2 = void 0;
        if (null == D2 || "object" !== (void 0 === D2 ? "undefined" : i(D2)) || Array.isArray(D2) || (F2 = D2.space, o2 = D2.quote, D2 = D2.replacer), "function" == typeof D2)
          E2 = D2;
        ...
        return F2 instanceof Number ? F2 = Number(F2) : F2 instanceof String && (F2 = String(F2)), "number" == typeof F2 ? F2 > 0 && (F2 = Math.min(10, Math.floor(F2)), n2 = "          ".substr(0, F2)) : "string" == typeof F2 && (n2 = F2.substr(0, 10)), v2("", { "": u2 });
        function v2(u3, D3) {
          var F3 = D3[u3];
          ...
          return "string" == typeof F3 ? m2(F3) : "number" == typeof F3 ? String(F3) : "object" === (void 0 === F3 ? "undefined" : i(F3)) ? Array.isArray(F3) ? function(u4) {
            if (e2.indexOf(u4) >= 0)
            ...
            var D4 = C3;
            C3 += n2;
            var F4 = A2 || Object.keys(u4), r2 = [], t3 = true, E3 = false, i2 = void 0;
            try {
              for (var o3, a3 = F4[Symbol.iterator](); !(t3 = (o3 = a3.next()).done); t3 = true) {
                var B3 = o3.value, c3 = v2(B3, u4);
                if (void 0 !== c3) {
                  var s3 = p2(B3) + ":";
                  "" !== n2 && (s3 += " "), s3 += c3, r2.push(s3);
                }
              }
            } catch (u5) {
              E3 = true, i2 = u5;
            ...
            return e2.pop(), C3 = D4, f3;
          }(F3) : void 0;
        }
        function m2(u3) {
          var D3 = { "'": 0.1, '"': 0.2 }, F3 = { "'": "\\'", '"': '\\"', "\\": "\\\\", "\b": "\\b", "\f": "\\f", "\n": "\\n", "\r": "\\r", "	": "\\t", "\v": "\\v", "\0": "\\0", "\u2028": "\\u2028", "\u2029": "\\u2029" }, e3 = "", C4 = true, A3 = false, r2 = void 0;
          try {
            for (var t3, E3 = u3[Symbol.iterator](); !(C4 = (t3 = E3.next()).done); C4 = true) {
              var n3 = t3.value;
              switch (n3) {
                case "'":
                case '"':
              ...
              if (F3[n3])
                ...
                var i2 = n3.charCodeAt(0).toString(16);
                e3 += "\\x" + ("00" + i2).substring(i2.length);
              } else
                e3 += n3;
            }
          } catch (u4) {
...
// node_modules/@sanity/vision/lib/_chunks/SanityVision-ce40d94b.esm.js
...
var TextLeaf = class extends Text2 {
...
var TextNode = class extends Text2 {
...
var EditorState = class {
  ...
  toText(string2) {
    return Text2.of(string2.split(this.facet(EditorState.lineSeparator) || DefaultSplit));
  }
  ...
  static create(config2 = {}) {
    ...
    let doc2 = config2.doc instanceof Text2 ? config2.doc : Text2.of((config2.doc || "").split(configuration.staticFacet(EditorState.lineSeparator) || DefaultSplit));
...
var CompletionTooltip = class {
  ...
  measureInfo() {
    ...
    if (infoRect.width <= (left ? spaceLeft : spaceRight)) {
      ...
      narrow = true;
      maxWidth = Math.min(400, (rtl ? listRect.right : space2.right - listRect.left) - 30) + "px";
  ...
  for (let a of active)
    if (a.hasResult()) {
      if (a.result.filter === false) {
        ...
        let matcher2 = new FuzzyMatcher(state.sliceDoc(a.from, a.to)), match;
        for (let option of a.result.options)
...
function snippet(template2) {
  ...
  return (editor, _completion, from, to) => {
    ...
    let spec = {
      changes: { from, to, insert: Text2.of(text) },
      scrollIntoView: true
    };
    if (ranges.length)
...
function useCodeMirror(props) {
  ...
  var [container, setContainer] = (0, import_react2.useState)();
  var [view, setView] = (0, import_react2.useState)();
  var [state, setState] = (0, import_react2.useState)();
  ...
  (0, import_react2.useEffect)(() => setContainer(props.container), [props.container]);
  (0, import_react2.useEffect)(() => () => {
    if (view) {
      view.destroy();
      setView(void 0);
...
var ReactCodeMirror = (0, import_react3.forwardRef)((props, ref) => {
  var {
    className,
    value = "",
    selection: selection2,
  ...
  var editor = (0, import_react3.useRef)(null);
  var {
    state,
    view,
    container,
...
var Stack2 = class {
  ...
  static start(p, state, pos = 0) {
    ...
    return new Stack2(p, [], state, pos, pos, 0, [], 0, cx ? new StackContext(cx, cx.start) : null, 0, null);
  }
  get context() {
  ...
  split() {
    ...
    while (parent && base2 == parent.bufferBase)
      parent = parent.parent;
    return new Stack2(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, buffer, base2, this.curContext, this.lookAhead, parent);
  }
...
function DelayedSpinner(props) {
  ...
  return show ? (0, import_jsx_runtime2.jsx)(Spinner, {
    muted: true,
    size: 4
  }) : null;
}
...
function useCodemirrorTheme(theme2) {
  const cmTheme = (0, import_react4.useMemo)(() => createTheme(theme2), [theme2]);
  const cmHighlight = (0, import_react4.useMemo)(() => syntaxHighlighting(createHighlight(theme2)), [theme2]);
...
function createTheme(theme2) {
  ...
  const cursor2 = hues.blue[color.dark ? 400 : 500].hex;
  const selection2 = hues.gray[theme2.sanity.color.dark ? 900 : 100].hex;
...
function createHighlight(theme2) {
  const c = theme2.sanity.color.base;
  const s = theme2.sanity.color.syntax;
...
var EditorRoot = styled_components_browser_esm_default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  width: 100%;\n  box-sizing: border-box;\n  height: 100%;\n  overflow: hidden;\n  position: relative;\n  display: flex;\n\n  & .cm-theme {\n    width: 100%;\n  }\n\n  & .cm-editor {\n    height: 100%;\n\n    font-size: 16px;\n    line-height: 21px;\n  }\n\n  & .cm-line {\n    padding-left: ", ";\n  }\n\n  & .cm-content {\n    border-right-width: ", " !important;\n    padding-top: ", ";\n  }\n"])), (_ref) => {
  let {
    theme: theme2
  } = _ref;
  return rem(theme2.sanity.space[3]);
}, (_ref2) => {
  let {
    theme: theme2
  } = _ref2;
  return rem(theme2.sanity.space[4]);
}, (_ref3) => {
  let {
    theme: theme2
  } = _ref3;
  return rem(theme2.sanity.space[5]);
});
function VisionCodeMirror(props) {
  const sanityTheme = useTheme();
  const theme2 = useCodemirrorTheme(sanityTheme);
  return (0, import_jsx_runtime2.jsx)(EditorRoot, {
    children: (0, import_jsx_runtime2.jsx)(esm_default, _objectSpread({
      basicSetup: false,
      theme: theme2,
...
function getLocalStorage(namespace) {
  ...
  function merge(props) {
    const state = _objectSpread(_objectSpread({}, ensureState()), props);
...
function tryParseParams(val) {
  try {
    const parsed = val ? import_json5.default.parse(val) : {};
...
function encodeQueryString(query) {
  ...
  return Object.keys(params).reduce((qs, param) => "".concat(qs, "&").concat(enc("$".concat(param)), "=").concat(enc(JSON.stringify(params[param]))), "?query=".concat(enc(query)));
}
var RO = typeof document === "undefined" ? ResizeObserver2 : window.ResizeObserver;
var defaultValue = "{\n  \n}";
function ParamsEditor(props) {
  ...
  const [isValid, setValid] = (0, import_react4.useState)(valid);
  (0, import_react4.useEffect)(() => onChange({
    parsed,
    raw: value,
    valid: isValid,
    error
  }), []);
  const handleChangeRaw = (0, import_react4.useCallback)((newValue) => {
    const event = eventFromValue(newValue);
    setValid(event.valid);
    onChange(event);
  }, [onChange]);
  const handleChange = (0, import_react4.useMemo)(() => (0, import_debounce.default)(handleChangeRaw, 333), [handleChangeRaw]);
  return (0, import_jsx_runtime2.jsx)(VisionCodeMirror, {
...
var ResultViewWrapper = styled_components_browser_esm_default.div((_ref4) => {
  let {
    theme: theme2
  } = _ref4;
  const {
  ...
  return Ce(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    & .json-inspector,\n    & .json-inspector .json-inspector__selection {\n      font-family: ", ";\n      font-size: ", "px;\n      line-height: ", "px;\n      color: var(--card-code-fg-color);\n    }\n\n    & .json-inspector .json-inspector__leaf {\n      padding-left: ", ";\n    }\n\n    & .json-inspector .json-inspector__leaf.json-inspector__leaf_root {\n      padding-top: ", ";\n      padding-left: 0;\n    }\n\n    & .json-inspector > .json-inspector__leaf_root > .json-inspector__line > .json-inspector__key {\n      display: none;\n    }\n\n    & .json-inspector .json-inspector__line {\n      display: block;\n      position: relative;\n      cursor: default;\n    }\n\n    & .json-inspector .json-inspector__line::after {\n      content: '';\n      position: absolute;\n      top: 0;\n      left: -200px;\n      right: -50px;\n      bottom: 0;\n      z-index: -1;\n      pointer-events: none;\n    }\n\n    & .json-inspector .json-inspector__line:hover::after {\n      background: var(--card-code-bg-color);\n    }\n\n    & .json-inspector .json-inspector__leaf_composite > .json-inspector__line {\n      cursor: pointer;\n    }\n\n    & .json-inspector .json-inspector__leaf_composite > .json-inspector__line::before {\n      content: '\u25B8 ';\n      margin-left: calc(0px - ", ");\n      font-size: ", "px;\n      line-height: ", "px;\n    }\n\n    &\n      .json-inspector\n      .json-inspector__leaf_expanded.json-inspector__leaf_composite\n      > .json-inspector__line::before {\n      content: '\u25BE ';\n      font-size: ", "px;\n      line-height: ", "px;\n    }\n\n    & .json-inspector .json-inspector__radio,\n    & .json-inspector .json-inspector__flatpath {\n      display: none;\n    }\n\n    & .json-inspector .json-inspector__value {\n      margin-left: ", ";\n    }\n\n    &\n      .json-inspector\n      > .json-inspector__leaf_root\n      > .json-inspector__line\n      > .json-inspector__key\n      + .json-inspector__value {\n      margin: 0;\n    }\n\n    & .json-inspector .json-inspector__key {\n      color: ", ";\n    }\n\n    & .json-inspector .json-inspector__value_helper,\n    & .json-inspector .json-inspector__value_null {\n      color: ", ";\n    }\n\n    & .json-inspector .json-inspector__not-found {\n      padding-top: ", ";\n    }\n\n    & .json-inspector .json-inspector__value_string {\n      color: ", ";\n      word-break: break-word;\n    }\n\n    & .json-inspector .json-inspector__value_boolean {\n      color: ", ";\n    }\n\n    & .json-inspector .json-inspector__value_number {\n      color: ", ";\n    }\n\n    & .json-inspector .json-inspector__show-original {\n      display: inline-block;\n      padding: 0 6px;\n      cursor: pointer;\n    }\n\n    & .json-inspector .json-inspector__show-original:hover {\n      color: inherit;\n    }\n\n    & .json-inspector .json-inspector__show-original::before {\n      content: '\u2194';\n    }\n\n    & .json-inspector .json-inspector__show-original:hover::after {\n      content: ' expand';\n    }\n  "])), fonts.code.family, fonts.code.sizes[2].fontSize, fonts.code.sizes[2].lineHeight, rem(space2[4]), rem(space2[0]), rem(space2[4]), fonts.code.sizes[2].fontSize, fonts.code.sizes[2].lineHeight, fonts.code.sizes[2].fontSize, fonts.code.sizes[2].lineHeight, rem(space2[4] / 2), color.syntax.property, color.syntax.constant, rem(space2[2]), color.syntax.string, color.syntax.boolean, color.syntax.number);
});
var lru = (0, import_hashlru.default)(5e4);
function ResultView(props) {
  const {
    data
  } = props;
  if (isRecord(data) || Array.isArray(data)) {
    return (0, import_jsx_runtime2.jsx)(ResultViewWrapper, {
      children: (0, import_jsx_runtime2.jsx)(import_react_json_inspector.default, {
        data,
        search: false,
        isExpanded,
...
var ErrorCode = styled_components_browser_esm_default(Code)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  color: ", ";\n"])), (_ref5) => {
  let {
    theme: theme2
  } = _ref5;
  return theme2.sanity.color.muted.critical.enabled.fg;
});
function QueryErrorDetails(_ref6) {
  ...
  const details = _objectSpread(_objectSpread({}, error.details), mapToLegacyDetails(error.details));
  if (!details.line) {
    return null;
  }
  return (0, import_jsx_runtime2.jsxs)("div", {
    children: [(0, import_jsx_runtime2.jsx)(ErrorCode, {
      size: 1,
...
function QueryErrorDialog(props) {
  return (0, import_jsx_runtime2.jsxs)(Stack, {
    space: 5,
    marginTop: 2,
    children: [(0, import_jsx_runtime2.jsx)(ErrorCode, {
      size: 1,
      children: props.error.message
    }), (0, import_jsx_runtime2.jsx)(QueryErrorDetails, {
      error: props.error
    })]
  });
}
var Root = styled_components_browser_esm_default(Flex)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  .sidebarPanes .Pane {\n    overflow-y: auto;\n    overflow-x: hidden;\n  }\n\n  & .Resizer {\n    background: var(--card-border-color);\n    opacity: 1;\n    z-index: 1;\n    box-sizing: border-box;\n    background-clip: padding-box;\n    border: solid transparent;\n  }\n\n  & .Resizer:hover {\n    border-color: var(--card-shadow-ambient-color);\n  }\n\n  & .Resizer.horizontal {\n    height: 11px;\n    margin: -5px 0;\n    border-width: 5px 0;\n    cursor: row-resize;\n    width: 100%;\n    z-index: 4;\n  }\n\n  & .Resizer.vertical {\n    width: 11px;\n    margin: 0 -5px;\n    border-width: 0 5px;\n    cursor: col-resize;\n    z-index: 2; /* To prevent the resizer from being hidden behind CodeMirror scroll area */\n  }\n\n  .Resizer.disabled {\n    cursor: not-allowed;\n  }\n\n  .Resizer.disabled:hover {\n    border-color: transparent;\n  }\n"])));
Root.displayName = "Root";
var Header = styled_components_browser_esm_default(Card)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  border-bottom: 1px solid var(--card-border-color);\n"])));
var StyledLabel = styled_components_browser_esm_default(Label)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  flex: 1;\n"])));
var SplitpaneContainer = styled_components_browser_esm_default(Box)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  position: relative;\n"])));
var QueryCopyLink = styled_components_browser_esm_default.a(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  margin-right: auto;\n"])));
var InputBackgroundContainer = styled_components_browser_esm_default(Box)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 1rem;\n  left: 0;\n  padding: 0;\n  margin: 0;\n  z-index: 10;\n  right: 0;\n\n  ", " {\n    user-select: none;\n  }\n"])), StyledLabel);
var InputBackgroundContainerLeft = styled_components_browser_esm_default(InputBackgroundContainer)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  // This is so its aligned with the gutters of CodeMirror\n  left: 33px;\n"])));
var InputContainer = styled_components_browser_esm_default(Card)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 100%;\n  position: relative;\n  flex-direction: column;\n"])));
var ResultOuterContainer = styled_components_browser_esm_default(Flex)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  height: 100%;\n"])));
var ResultInnerContainer = styled_components_browser_esm_default(Box)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  position: relative;\n"])));
var ResultContainer = styled_components_browser_esm_default(Card)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  height: 100%;\n  width: 100%;\n  position: absolute;\n  max-width: 100%;\n\n  ", "\n"])), (_ref7) => {
  let {
    $isInvalid
  } = _ref7;
  return $isInvalid && Ce(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n      &:after {\n        background-color: var(--card-bg-color);\n        content: '';\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n        width: 100%;\n      }\n    "])));
});
var Result = styled_components_browser_esm_default(Box)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  z-index: 20;\n"])));
var TimingsFooter = styled_components_browser_esm_default(Box)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  border-top: 1px solid var(--card-border-color);\n"])));
var TimingsCard = styled_components_browser_esm_default(Card)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  position: relative;\n"])));
styled_components_browser_esm_default(Box)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  width: 100%;\n  height: 100%;\n"])));
var TimingsTextContainer = styled_components_browser_esm_default(Flex)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  height: 100%;\n  min-height: ", ";\n"])), (_ref8) => {
  let {
    theme: theme2
  } = _ref8;
  return rem(theme2.sanity.space[3] * 2 + theme2.sanity.fonts.text.sizes[2].lineHeight - theme2.sanity.fonts.text.sizes[2].ascenderHeight - theme2.sanity.fonts.text.sizes[2].descenderHeight);
});
var ControlsContainer = styled_components_browser_esm_default(Box)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  border-top: 1px solid var(--card-border-color);\n"])));
var ButtonFullWidth = styled_components_browser_esm_default(Button)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
...
var sanityUrl = /\.(?:api|apicdn)\.sanity\.io\/(vx|v1|v\d{4}-\d\d-\d\d)\/.*?(?:query|listen)\/(.*?)\?(.*)/;
var isRunHotkey = (event) => (0, import_is_hotkey.default)("ctrl+enter", event) || (0, import_is_hotkey.default)("mod+enter", event);
...
var VisionGui = class extends import_react4.default.PureComponent {
  constructor(props) {
    super(props);
    const {
      client,
    ...
    const defaultDataset = config2.defaultDataset || client.config().dataset || datasets[0];
    const defaultApiVersion = prefixApiVersion("".concat(config2.defaultApiVersion));
    ...
    this._visionRoot = import_react4.default.createRef();
    this._operationUrlElement = import_react4.default.createRef();
    this._queryEditorContainer = import_react4.default.createRef();
    this._paramsEditorContainer = import_react4.default.createRef();
    this._customApiVersionElement = import_react4.default.createRef();
  ...
  handleChangeApiVersion(evt) {
    ...
    if (apiVersion === "other") {
      this.setState({
        ...
        var _a2;
        (_a2 = this._customApiVersionElement.current) == null ? void 0 : _a2.focus();
      });
      return;
    }
  ...
  handleListenExecution() {
    ...
    const url = this._client.getUrl(this._client.getDataUrl("listen", encodeQueryString(query, encodeParams)));
  ...
  handleQueryExecution() {
    ...
    this.ensureSelectedApiVersion();
    const url = this._client.getUrl(this._client.getDataUrl("query", encodeQueryString(query, params)));
    this.setState({
      url
    });
  ...
  render() {
    ...
    return (0, import_jsx_runtime2.jsxs)(Root, {
      ...
      sizing: "border",
      overflow: "hidden",
      children: [(0, import_jsx_runtime2.jsx)(Header, {
        paddingX: 3,
        paddingY: 2,
        children: (0, import_jsx_runtime2.jsxs)(Grid, {
          columns: [6, 6, 12],
          children: [(0, import_jsx_runtime2.jsx)(Box, {
            padding: 1,
            column: 2,
            children: (0, import_jsx_runtime2.jsxs)(Stack, {
              children: [(0, import_jsx_runtime2.jsx)(Card, {
                paddingY: 2,
                children: (0, import_jsx_runtime2.jsx)(StyledLabel, {
                  children: "Dataset"
                })
              }), (0, import_jsx_runtime2.jsx)(Select, {
                value: dataset,
                onChange: this.handleChangeDataset,
                children: datasets.map((ds) => (0, import_jsx_runtime2.jsx)("option", {
                  children: ds
                }, ds))
              })]
            })
            ...
            children: (0, import_jsx_runtime2.jsxs)(Stack, {
              ...
              }), (0, import_jsx_runtime2.jsxs)(Select, {
                value: customApiVersion === false ? apiVersion : "other",
                onChange: this.handleChangeApiVersion,
                children: [API_VERSIONS.map((version) => (0, import_jsx_runtime2.jsx)("option", {
                  children: version
                }, version)), (0, import_jsx_runtime2.jsx)("option", {
                  value: "other",
                  children: "Other"
                }, "other")]
              })]
            })
          }), customApiVersion !== false && (0, import_jsx_runtime2.jsx)(Box, {
            padding: 1,
            column: 2,
            children: (0, import_jsx_runtime2.jsxs)(Stack, {
              children: [(0, import_jsx_runtime2.jsx)(Card, {
          ...
          }), typeof url === "string" ? (0, import_jsx_runtime2.jsx)(Box, {
            padding: 1,
            flex: 1,
            column: customApiVersion === false ? 8 : 6,
            children: (0, import_jsx_runtime2.jsxs)(Stack, {
              children: [(0, import_jsx_runtime2.jsx)(Card, {
                paddingY: 2,
                children: (0, import_jsx_runtime2.jsxs)(StyledLabel, {
                  children: ["Query URL\xA0", (0, import_jsx_runtime2.jsx)(QueryCopyLink, {
                ...
                children: [(0, import_jsx_runtime2.jsx)(Box, {
                  flex: 1,
                  children: (0, import_jsx_runtime2.jsx)(TextInput, {
                    readOnly: true,
                    type: "url",
                    ref: this._operationUrlElement,
                    value: url
                  })
                }), (0, import_jsx_runtime2.jsx)(Tooltip, {
                  content: (0, import_jsx_runtime2.jsx)(Box, {
                    padding: 2,
      ...
      }), (0, import_jsx_runtime2.jsx)(SplitpaneContainer, {
        flex: 1,
        children: (0, import_jsx_runtime2.jsxs)(index_esm_default, {
          split: "vertical",
          minSize: 280,
          defaultSize: 400,
          maxSize: -400,
          children: [(0, import_jsx_runtime2.jsx)(Box, {
            ...
            children: (0, import_jsx_runtime2.jsxs)(index_esm_default, {
              ...
              primary: "first",
              children: [(0, import_jsx_runtime2.jsx)(InputContainer, {
                display: "flex",
                ref: this._queryEditorContainer,
                children: (0, import_jsx_runtime2.jsxs)(Box, {
                  flex: 1,
                  children: [(0, import_jsx_runtime2.jsx)(InputBackgroundContainerLeft, {
                  ...
                  }), (0, import_jsx_runtime2.jsx)(VisionCodeMirror, {
                    value: this.state.query,
                    onChange: this.handleQueryChange
                  })]
                })
              }), (0, import_jsx_runtime2.jsxs)(InputContainer, {
                display: "flex",
                  ...
                  children: [(0, import_jsx_runtime2.jsx)(InputBackgroundContainerLeft, {
                    children: (0, import_jsx_runtime2.jsxs)(Flex, {
                      children: [(0, import_jsx_runtime2.jsx)(StyledLabel, {
                        muted: true,
                        children: "Params"
                      }), paramsError && (0, import_jsx_runtime2.jsx)(Tooltip, {
                        placement: "top-end",
                        content: (0, import_jsx_runtime2.jsx)(Box, {
                          padding: 2,
                          children: (0, import_jsx_runtime2.jsx)(Text, {
                        ...
                        children: (0, import_jsx_runtime2.jsx)(Box, {
                          ...
                          marginX: 2,
                          children: (0, import_jsx_runtime2.jsx)(Text, {
                            children: (0, import_jsx_runtime2.jsx)(ErrorOutlineIcon, {})
                          })
                        })
                      })]
                    })
                  }), (0, import_jsx_runtime2.jsx)(ParamsEditor, {
                    value: this.state.rawParams,
                    onChange: this.handleParamsChange
                  })]
                }), (0, import_jsx_runtime2.jsx)(ControlsContainer, {
                  children: (0, import_jsx_runtime2.jsx)(Card, {
                    padding: 3,
                    paddingX: 3,
                    children: (0, import_jsx_runtime2.jsx)(Tooltip, {
                      content: (0, import_jsx_runtime2.jsx)(Card, {
                        padding: 2,
                        radius: 4,
                        children: (0, import_jsx_runtime2.jsx)(Text, {
                          size: 1,
                      ...
                      children: (0, import_jsx_runtime2.jsxs)(Flex, {
                        ...
                        children: [(0, import_jsx_runtime2.jsx)(Box, {
                          ...
                          children: (0, import_jsx_runtime2.jsx)(Tooltip, {
                            ...
                            placement: "top",
                            portal: true,
                            children: (0, import_jsx_runtime2.jsx)(ButtonFullWidth, {
          ...
          }), (0, import_jsx_runtime2.jsxs)(ResultOuterContainer, {
            direction: "column",
            children: [(0, import_jsx_runtime2.jsx)(ResultInnerContainer, {
              flex: 1,
              children: (0, import_jsx_runtime2.jsx)(ResultContainer, {
                flex: 1,
                overflow: "hidden",
                tone: error ? "critical" : "default",
                $isInvalid: Boolean(error),
                children: (0, import_jsx_runtime2.jsxs)(Result, {
                  padding: 3,
                  paddingTop: 5,
                  overflow: "auto",
                  children: [(0, import_jsx_runtime2.jsx)(InputBackgroundContainer, {
                    children: (0, import_jsx_runtime2.jsx)(Box, {
                      marginLeft: 3,
                      children: (0, import_jsx_runtime2.jsx)(StyledLabel, {
                        muted: true,
                  ...
                  }), (queryInProgress || listenInProgress && listenMutations.length === 0) && (0, import_jsx_runtime2.jsx)(Box, {
                    marginTop: 3,
                    children: (0, import_jsx_runtime2.jsx)(DelayedSpinner, {})
                  }), error && (0, import_jsx_runtime2.jsx)(Box, {
                    children: (0, import_jsx_runtime2.jsx)(QueryErrorDialog, {
                      error
                    })
                  }), hasResult && (0, import_jsx_runtime2.jsx)(ResultView, {
                    data: queryResult
                  }), listenInProgress && listenMutations.length > 0 && (0, import_jsx_runtime2.jsx)(ResultView, {
                    data: listenMutations
                  })]
                })
              })
            }), (0, import_jsx_runtime2.jsx)(TimingsFooter, {
              children: (0, import_jsx_runtime2.jsx)(TimingsCard, {
                paddingX: 4,
                paddingY: 3,
                sizing: "border",
                children: (0, import_jsx_runtime2.jsxs)(TimingsTextContainer, {
                  align: "center",
                  children: [(0, import_jsx_runtime2.jsx)(Box, {
...
function VisionContainer(props) {
  ...
  if (!loadedDatasets) {
    return (0, import_jsx_runtime2.jsx)(DelayedSpinner, {});
  }
  const datasets = loadedDatasets instanceof Error ? [props.client.config().dataset || "production"] : loadedDatasets;
  return (0, import_jsx_runtime2.jsx)(VisionGui, _objectSpread(_objectSpread({}, props), {}, {
    datasets,
    toast
  }));
}
function SanityVision(props) {
  ...
  const config2 = _objectSpread({
    defaultApiVersion: DEFAULT_API_VERSION
  }, props.tool.options);
  return (0, import_jsx_runtime2.jsx)(VisionContainer, {
    client,
    config: config2
  });
}
...
//# sourceMappingURL=SanityVision-ce40d94b.esm-N6WASJ5O.js.map
