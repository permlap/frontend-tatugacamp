    ...
    if (user) {
      Swal.fire({
        ...
        html:
          ...
          "<br/>" +
          "<span>ส่งผลให้ค่าใช้จ่ายในการเช่า Server และ Database สูงมาก และเกินกำลังสำหรับทางเรา พอสมควร เนื่องจากผู้พัฒนาเว็บไซต์เป็นเพียงกลุ่มนักศึกษาครุศาสตร์ สาขาภาษาอังกฤษ ที่เพิ่งจบใหม่ที่ จึงไม่สามารถหารายได้มาจ่ายในส่วนของค่าใช้จ่ายเหล่านี้ได้ พวกเราจึงขอเปิดรับการสนับสนุนจากคุณครูทุกท่าน เพื่อซัพพอร์ตให้เราสามารถพัฒนาเว็บไซต์ดี ๆ และเป็นประโยชน์ต่อคุณครู นักศึกษาฝึกสอน อาจารย์ และการศึกษาไทยต่อไปครับ </span>",
